...
/**
 * <p>
 * A Constraint was not met by an Instance.  For example, the
 * value was out of range, contained invalid data, was null, and so on.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new ConstraintException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     ConstraintException.  The localized Message
    ...
    /**
     * <p>
     * Creates a new ConstraintException with the specified Message.
     * </p>
     *
     * @param message The Message for this ConstraintException.
    ...
    /**
     * <p>
     * Creates a new ConstraintException with the specified String text.
     * </p>
     *
     * @param text The text for this ConstraintException.
     *             The localized Message will be looked up by Locale
    ...
    /**
     * <p>
     * Returns the constraint which failed.
     * </p>
     *
     * @return The Constraint which failed.  Never null.
     */
    public Constraint constraint ()
    {
        Object constraint = this.message ().parameter ( "constraint" );
        if ( constraint != null
    ...
    /**
     * <p>
     * Returns the instance which failed the Constraint,
     * if any was specified during construction of this exception.
     * </p>
     *
     * <p>
     * Not all ConstraintExceptions have to do with Instances.
     * For example, a "value out of range" ConstraintException
     * certainly does apply to an Instance.  However an "invalid
     * parameter to a Constraints constructor" ConstraintException
     * does not apply to any Instance.
     * </p>
     *
     * <p>
     * Note that if the Instance specified was not Serializable,
     * then it was turned into a Serializable representation
     * (for example, by calling its toString() method) in order
     * for the exception to play nicely across RMI.
     * </p>
     *
     * @return The Instance which failed a Constraint, if any.
     *         Can be null.
     */
    public Serializable instance ()
    {
        Object instance = this.message ().parameter ( "instance" );
        if ( instance != null )
        {
