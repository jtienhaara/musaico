...
/**
 * <p>
 * Exception caused while casting from one Type to another.
 * </p>
 *
 * <p>
 * Generally TypeCastExceptions are only ever handled by
 * a type system's exception handler (which might wrap the
 * exception in a RuntimeTypeException, or it might shut
 * down the application completely, or it might simply
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new TypeCastException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     TypeCastException.  The localized Message
    ...
    /**
     * <p>
     * Creates a new TypeCastException with the specified Message.
     * </p>
     *
     * @param message The Message for this TypeCastException.
    ...
    /**
     * <p>
     * Creates a new TypeCastException with the specified String text.
     * </p>
     *
     * @param text The text for this TypeCastException.
     *             The localized Message will be looked up by Locale
