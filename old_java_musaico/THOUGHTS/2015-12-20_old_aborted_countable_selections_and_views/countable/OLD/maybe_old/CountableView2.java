    ...
    extends Serializable
{
    ...
    // !!!
    public abstract CountableFilteredView<VALUE, VIEW_ITEM, VIEW> filter (
            CountableFilter clause
            );
    ...
    // !!!
    public abstract CountableSortedView<VALUE, VIEW_ITEM, VIEW> sort (
            CountableSort clause
            );
