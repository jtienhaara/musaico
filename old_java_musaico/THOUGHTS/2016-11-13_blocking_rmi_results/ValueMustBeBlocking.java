...
/**
 * <p>
 * A guarantee of a blocking value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeBlocking
    implements Contract<Value<?>, ValueMustBeBlocking.Violation>, Serializable
{
    ...
    /** The ValueMustBeBlocking contract. */
    public static final ValueMustBeBlocking CONTRACT =
        new ValueMustBeBlocking ();
    ...
    {
        return "The value must be Blocking, a value which is initially"
     ...
     */
    @Override
    public ValueMustBeBlocking.Violation violation (
                                                    Object plaintiff,
                                                    Value<?> evidence
                                                    )
    {
        return new ValueMustBeBlocking.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final ValueMustBeBlocking.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeBlocking contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeBlocking.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeBlocking.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The value was not Blocking.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
