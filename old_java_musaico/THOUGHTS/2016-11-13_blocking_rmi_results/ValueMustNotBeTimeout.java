...
/**
 * <p>
 * A guarantee of any value except a timeout value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeTimeout
    implements Contract<Value<?>, ValueMustNotBeTimeout.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeTimeout contract. */
    public static final ValueMustNotBeTimeout CONTRACT =
        new ValueMustNotBeTimeout ();
    ...
    {
        return "The value must not be Timeout.";
    }
     ...
     */
    @Override
    public ValueMustNotBeTimeout.Violation violation (
                                                      Object plaintiff,
                                                      Value<?> evidence
                                                      )
    {
        return new ValueMustNotBeTimeout.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final ValueMustNotBeTimeout.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeTimeout contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeTimeout.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeTimeout.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The value was Timeout.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
