...
/**
 * <p>
 * A guarantee that each Cancellable has not been cancelled.
 * </p>
 *
 *
 * <p>
 ...
 */
public class CancellableMustNotBeCancelled
    implements Contract<Cancellable, CancellableMustNotBeCancelled.Violation>, Serializable
{
    ...
    public static final CancellableMustNotBeCancelled CONTRACT =
        new CancellableMustNotBeCancelled ();


    private CancellableMustNotBeCancelled ()
    {
    }
    ...
    {
        return "A Cancellable object must never have been cancelled.";
    }
     ...
     */
    @Override
    public CancellableMustNotBeCancelled.Violation violation (
            Object plaintiff,
            Cancellable evidence
            )
    {
        return new CancellableMustNotBeCancelled.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    /**
     * <p>
     * A violation of the CancellableMustNotBeCancelled contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            CancellableMustNotBeCancelled.serialVersionUID;


        /**
         * <p>
         * Creates a new CancellableMustNotBeCancelled.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The specified Cancellable has been cancelled: "
                    + evidence
                    + ".", // description
                    plaintiff,
                    evidence,
