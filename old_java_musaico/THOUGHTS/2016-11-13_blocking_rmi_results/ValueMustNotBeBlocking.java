...
/**
 * <p>
 * A guarantee of any value except a blocking value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeBlocking
    implements Contract<Value<?>, ValueMustNotBeBlocking.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeBlocking contract. */
    public static final ValueMustNotBeBlocking CONTRACT =
        new ValueMustNotBeBlocking ();
    ...
    {
        return "The value must not be Blocking.";
    }
                               ...
                               )
    {
        ...
        else if ( value instanceof Blocking )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public ValueMustNotBeBlocking.Violation violation (
                                                       Object plaintiff,
                                                       Value<?> evidence
                                                       )
    {
        return new ValueMustNotBeBlocking.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    {
        final ValueMustNotBeBlocking.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeBlocking contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeBlocking.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeBlocking.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The value was Blocking.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
