 ...
 *     ImpossibleTime + AbstractCalendarOffset = ImpossibleTime
    ...
    implements Time, Serializable
{
    ...
    private static final String serialVersionHash =
        "0x584C2AA31A2A8DF905CBE9B1E6D8569ACD04DB53";
    ...
    public long milliseconds ()
    {
        ...
        final long seconds = this.seconds ();
        if ( seconds >= ( Long.MAX_VALUE / 1000L ) )
        {
            return Long.MAX_VALUE;
        }
        else if ( seconds <= ( Long.MIN_VALUE / 1000L ) )
        {
