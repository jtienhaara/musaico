...
/**
 * <p>
 * The start of a record inside some data stream.
 * </p>
 *
 *
 * <p>
    ...
    implements Marker, Serializable
{
    ...
    /**
     * <p>
     * Creates a new RecordStart for the specified
     * record name.
     * </p>
     *
        ...
        throws I18nIllegalArgumentException
    {
        if ( record_name == null )
        {
            throw new I18nIllegalArgumentException ( "Cannot create a RecordStart for record [%record%]",
                                                     "record", record_name );
        }
    ...
    /**
     * <p>
     * Creates a new RecordStart with the specified reference as a
     * record name.
     * </p>
     *
    ...
    {
        if ( obj == null
             || ! ( obj instanceof RecordStart ) )
        {
            return false;
        }

        RecordStart that = (RecordStart) obj;
