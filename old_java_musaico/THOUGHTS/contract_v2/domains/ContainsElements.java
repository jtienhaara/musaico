...
/**
 * <p>
 * The domain of all arrays and collections which contain a specific
 * subset of elements.
 * </p>
 *
 *
    ...
    implements ArrayDomain<Object /* array, Collection */>, Serializable
{
    ...
    private static final String serialVersionHash =
        "0x3C97C5E784275AB57BE15D8CE17691C98A416994";
        ...
        throws IllegalArgumentException
    {
        if ( elements == null )
        {
            throw new IllegalArgumentException ( "Cannot create a ContainsElements ( " + elements + " )" );
        }
