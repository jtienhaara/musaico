 ...
 * </pre>
 */
public abstract class DomainObligation<INSPECTABLE extends Object, DOMAIN_OBLIGATION_VIOLATION extends Throwable>
    implements Obligation<INSPECTABLE, DOMAIN_OBLIGATION_VIOLATION>, Serializable
{
    /** No domain obligation whatsoever.  Anything goes. */
    public static final NoDomainObligation<Object> NONE =
        new NoDomainObligation<Object> ( Domain.NONE );
    ...
    /**
     * <p>
     * Creates a new DomainObligation requiring that all inspectable
     ...
     *               Must not be null.
     */
    public DomainObligation (
                             Domain<INSPECTABLE> domain
                             )
    {
        if ( domain == null )
        {
            throw new IllegalArgumentException ( "new DomainObligation ( " + domain + " )" );
        }
    ...
    /**
     * <p>
     * Returns the appropriate DomainObligationViolation for this
     * domain obligation, typically called only by enforce ().
     * </p>
     *
     * @param object_under_contract The object under contract, such
     *                              as an object whose method checks
     *                              parameters against this obligation.
     *                              Must not be null.
     *
     ...
     *         which failed to meet this contract (such as parameters
     *         to a method provided by the object under contract).
     *         Never null.
     */
    protected abstract DOMAIN_OBLIGATION_VIOLATION createViolation (
    ...
    /**
     * <p>
     * Returns the domain to which all obligated values must belong.
     * </p>
     *
    ...
    public final void enforce (
        ...
        throws DOMAIN_OBLIGATION_VIOLATION
    {
        ...
        if ( ! is_in_domain )
        {
            ...
            final DOMAIN_OBLIGATION_VIOLATION violation =
                           ...
                           )
    {
        ...
        DomainObligation<?, ?> that = (DomainObligation<?, ?>) obj;
     ...
     *         Never null.
     */
    public DOMAIN_OBLIGATION_VIOLATION violation (
                                                  Object object_under_contract,
                                                  INSPECTABLE inspectable_data
                                                  )
    {
