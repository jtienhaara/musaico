...
/**
 * <p>
 * An exception thrown by the security layer at runtime, typically
 * due to anonymous access violations (for example, invoking a
 * method without checking to see if access is allowed).
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new SecurityRuntimeException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     SecurityRuntimeException.  The localized Message
    ...
    /**
     * <p>
     * Creates a new SecurityRuntimeException with the specified Message.
     * </p>
     *
     * @param message The Message for this SecurityRuntimeException.
    ...
    /**
     * <p>
     * Creates a new SecurityRuntimeException with the specified String text.
     * </p>
     *
     * @param text The text for this SecurityRuntimeException.
     *             The localized Message will be looked up by Locale
