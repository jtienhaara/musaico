...
/**
 * <p>
 * An exception thrown by the security layer when a party
 * is not permitted some particular form of access (such
 * as instigating an operation on an object).
 * </p>
 *
 *
 * <p>
...
public class PermissionDeniedRuntimeException
    extends SecurityRuntimeException
    implements Serializable
{
    /**
     * <p>
     * Creates a new PermissionDeniedRuntimeException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     PermissionDeniedRuntimeException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public PermissionDeniedRuntimeException (
    ...
    /**
     * <p>
     * Creates a new PermissionDeniedRuntimeException with the specified Message.
     * </p>
     *
     * @param message The Message for this PermissionDeniedRuntimeException.
    ...
    /**
     * <p>
     * Creates a new PermissionDeniedRuntimeException with the specified String text.
     * </p>
     *
     * @param text The text for this PermissionDeniedRuntimeException.
     *             The localized Message will be looked up by Locale
