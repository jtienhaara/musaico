 ...
 * the child filter results ORed together result in KEEP.
 * </p>
 *
 * <p>
 * For example:
 ...
 *
 * <pre>
 *     Filter filter<ABC> = new Or ( new XFilter (),
 *                                   new YFilter (),
 *                                   new ZFilter () );
 ...
 * the specified object are ORed together to produce a KEEP result.
 ...
 * </pre>
 */
public class Or<INDEX extends java.lang.Object>
    implements Filter<INDEX>, Serializable
{
    /** The child filters of this "Or" filter. */
    ...
    /**
     * @return The size of this logical OR clause, in terms
