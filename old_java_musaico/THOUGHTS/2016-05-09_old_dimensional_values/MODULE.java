...
/**
 * <p>
 * Module settings for the musaico.foundation.value module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Provides conditional values (No, One, Many) with which the user chooses how to handle various unusual scenarios (nulls, exceptions, partial results, infinite results, blocking, and so on).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x3A4F18F2F521FD42E582397632D22D4EC9F32B77";
