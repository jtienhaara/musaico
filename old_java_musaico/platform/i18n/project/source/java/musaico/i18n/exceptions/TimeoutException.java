...
/**
 * <p>
 * An exception thrown after waiting for some length of time
 * for an operation to complete.
 * </p>
 *
 * <p>
 * After some duration, the operation had still not completed,
 * so this exception is thrown to notify the caller that it failed
 * to execute in a timely manner.
 * </p>
 *
 * <p>
 * To specify a Throwable cause for a TimeoutException, add
 ...
 *         new TimeoutException ( new SimpleMessageBuilder ()
 *                                .text ( "Message text" )
 *                                .parameter ( "cause", ex )
 *                                .build () );
 *         new TimeoutException ( "Message text",
 *                                "cause", ex );
 *     }
 * </pre>
 *
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new TimeoutException with the specified internationalized
     * Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     TimeoutException.  The localized Message
     ...
     * </p>
     *
     * @param message The Message for this TimeoutException.
    ...
    /**
     * <p>
     * Creates a new TimeoutException with the specified String text.
     * </p>
     *
     * @param text The text for this TimeoutException.
     *             The localized Message will be looked up by Locale
