...
/**
 * <p>
 * An I/O exception which has an internationalized message
 * token, localized versions, and international parameters.
 * </p>
 *
 * <p>
 * To specify a Throwable cause for an I18nIOException, add
 ...
 *         new I18nIOException ( new SimpleMessageBuilder ()
 *                               .text ( "Message text" )
 *                               .parameter ( "cause", ex )
 *                               .build () );
 *         new I18nIOException ( "Message text",
 *                               "cause", ex );
 *     }
 * </pre>
 *
    ...
    implements Internationalized<Message,String>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new I18nIOException with the specified Message.
     * </p>
     *
     * @param message The Message for this I18nIOException.
    ...
    /**
     * <p>
     * Creates a new I18nIOException with the specified String text.
     * </p>
     *
     * @param text The text for this I18nIOException.
     *             The localized Message will be looked up by Locale
