...
/**
 * <p>
 * An exception which has an internationalized message
 * token, localized versions, and international parameters.
 * </p>
 *
 * <p>
 * To specify a Throwable cause for an I18nException, add
 ...
 *         new I18nException ( new SimpleMessageBuilder ()
 *                             .text ( "Message text" )
 *                             .parameter ( "cause", ex )
 *                             .build () );
 *         new I18nException ( "Message text",
 *                             "cause", ex );
 *     }
 * </pre>
 *
...
{
    /** The Message for this I18nException.  Can be localized. */
    private final Internationalized<Message,String> i18nMessage;


    /**
     * <p>
     * Creates a new I18nException with the specified internationalized
     * Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     I18nException.  The localized Message
    ...
    /**
     * <p>
     * Creates a new I18nException with the specified Message.
     * </p>
     *
     * @param message The Message for this I18nException.
    ...
    /**
     * <p>
     * Creates a new I18nException with the specified String text.
     * </p>
     *
     * @param text The text for this I18nException.
     *             The localized Message will be looked up by Locale
