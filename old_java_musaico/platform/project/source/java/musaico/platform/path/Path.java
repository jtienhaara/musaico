    ...
    implements Serializable
{
    ...
    private static final String serialVersionHash =
        "0xFEB1C5FF41B6AD85B33AB6C11F1D4952EA8415B8";
    ...
    private static final ObjectContracts classContracts =
        new ObjectContracts ( Path.class );
    ...
    public Path (
        ...
        throws ParametersMustNotBeNull.Violation,
               Parameter1.MustBe.DomainViolation
    {
        classContracts.check ( ParametersMustNotBeNull.CONTRACT,
                               path_string );
        classContracts.check ( new Parameter1.MustBe<String> ( ValidPathString.DOMAIN ),
                               path_string );
    ...
    public Path append (
        ...
        throws ParametersMustNotBeNull.Violation,
               Parameter1.MustContainNoNulls.Violation
    {
        objectContracts.check ( ParametersMustNotBeNull.CONTRACT,
                                (Object []) names );
        objectContracts.check ( Parameter1.MustContainNoNulls.CONTRACT,
                                names );
