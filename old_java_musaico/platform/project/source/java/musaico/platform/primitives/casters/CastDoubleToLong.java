...
/**
 * <p>
 * Casts values from Double to Long.
 * </p>
 *
 *
 * <br> </br>
 ...
 * </pre>
 */
public class CastDoubleToLong
    implements TypeCaster<Double,Long>, Serializable
{
    /**
        ...
        throws TypeException
    {
        ...
        if ( ( (double) long_value ) != from.doubleValue () )
        {
            // Can't cast if there are decimals.
            double precision_loss = from.doubleValue () - (double) long_value;
