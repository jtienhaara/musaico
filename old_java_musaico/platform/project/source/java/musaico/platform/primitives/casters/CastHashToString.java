...
/**
 * <p>
 * Casts values from Hash to String.
 * </p>
 *
 *
 * <br> </br>
 ...
 * </pre>
 */
public class CastHashToString<FROM extends Hash>
    implements TypeCaster<FROM,String>, Serializable
{
     ...
     * (MD5, SHA1 and so on) to Strings.
     * </p>
     *
     * @param from_class The class of Hashes from which this caster
     *                   will cast to Strings, such as MD5.class
     *                   or SHA1.class and so on.  Must not be null.
     */
    public CastHashToString (
                             Class<FROM> from_class
                             )
    {
        if ( from_class == null )
        {
            throw new I18nIllegalArgumentException ( "Cannot create a typecaster to cast from Hash class [%from_class%] to class [%to_class%]",
