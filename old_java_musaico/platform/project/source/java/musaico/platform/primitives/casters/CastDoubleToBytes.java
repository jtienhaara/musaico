...
/**
 * <p>
 * Casts values from Double to byte array.
 * </p>
 *
 *
 * <br> </br>
 ...
 * </pre>
 */
public class CastDoubleToBytes
    implements TypeCaster<Double,byte[]>, Serializable
{
    /**
    ...
    {
        long bytes_as_long = Double.doubleToRawLongBits ( from.doubleValue () );
