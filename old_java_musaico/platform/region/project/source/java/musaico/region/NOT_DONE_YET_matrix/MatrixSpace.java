    ...
    implements Space, Serializable
{
    ...
    {
        return new ArrayRegion ( this.min (), this.max () );
    }
    ...
    {
        return new ArrayPosition ( Long.MAX_VALUE );
    }
