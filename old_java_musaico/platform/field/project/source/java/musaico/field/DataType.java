...
/**
 * <p>
 * Base type for all data containers (Fields, Buffers and so on).
 * </p>
 *
 * <p>
 * Every DataType must be Serializable and have casters to/from
 * all PrimitiveTypes.
 * </p>
 *
 * @see musaico.types.primitive.CastableToPrimitiveTypeSystem
 *
 * <p>
 * In Java, all DataTypes must be Serializable and use Serializable
 ...
 * </pre>
 */
public class DataType<STORAGE_VALUE extends Serializable>
    extends PrimitiveType<STORAGE_VALUE>
    implements Serializable
{
    /**
     * <p>
     * Creates a new DataType with the specified internationalized name
     * and storage class.
     * </p>
     *
     * <p>
