...
/**
 * <p>
 * Represents an exception which occurred during some object system
 * operation or other (possibly a RecordOperationException or
 * an ONodeOperationException, and so on).
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class ObjectSystemException
    extends I18nException
    implements Serializable
{
    /**
     * <p>
     * Creates a new ObjectSystemException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     ObjectSystemException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public ObjectSystemException (
    ...
    /**
     * <p>
     * Creates a new ObjectSystemException with the specified Message.
     * </p>
     *
     * @param message The Message for this ObjectSystemException.
    ...
    /**
     * <p>
     * Creates a new ObjectSystemException with the specified String text.
     * </p>
     *
     * @param text The text for this ObjectSystemException.
     *             The localized Message will be looked up by Locale
