...
/**
 * <p>
 * Advisory and other flags for accessing SuperBlocks.
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class SuperBlockFlag
    extends SimpleSoftReference<Path>
    implements Serializable
{
    /**
     * <p>
     * Creates a new SuperBlockFlag with the specified path.
     * </p>
     *
     * @param path The unique path identifier for this SuperBlockFlag.
     *             Must not be null.
     */
    protected SuperBlockFlag (
                              Path path
                              )
    {
        super ( path );
