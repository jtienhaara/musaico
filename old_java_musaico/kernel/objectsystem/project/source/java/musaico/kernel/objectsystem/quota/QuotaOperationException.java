...
/**
 * <p>
 * Represents an error which occurred while performing
 * a quota operation (creating a persistent quota, releasing
 * a persistent quota, writing a quota, and so on).
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class QuotaOperationException
    extends ObjectSystemException
    implements Serializable
{
    /**
     * <p>
     * Creates a new QuotaOperationException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     QuotaOperationException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public QuotaOperationException (
    ...
    /**
     * <p>
     * Creates a new QuotaOperationException with the specified Message.
     * </p>
     *
     * @param message The Message for this QuotaOperationException.
    ...
    /**
     * <p>
     * Creates a new QuotaOperationException with the specified String text.
     * </p>
     *
     * @param text The text for this QuotaOperationException.
     *             The localized Message will be looked up by Locale
