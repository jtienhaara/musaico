...
/**
 * <p>
 * Represents an exception which occurred during an operation on
 * an OEntry (such as adding or removing a child OEntry).
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class OEntryOperationException
    extends ObjectSystemException
    implements Serializable
{
    /**
     * <p>
     * Creates a new OEntryOperationException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     OEntryOperationException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public OEntryOperationException (
    ...
    /**
     * <p>
     * Creates a new OEntryOperationException with the specified Message.
     * </p>
     *
     * @param message The Message for this OEntryOperationException.
    ...
    /**
     * <p>
     * Creates a new OEntryOperationException with the specified String text.
     * </p>
     *
     * @param text The text for this OEntryOperationException.
     *             The localized Message will be looked up by Locale
