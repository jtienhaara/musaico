...
/**
 * <p>
 * Represents a security violation which occurred while performing some
 * sort of super-block operation (such as allocating or freeing
 * an ONode, performing an operation on an ONode, synchronizing
 * the object system represented by the super block, writing
 * out the super block content, and so on).
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class SuperBlockSecurityException
    extends SuperBlockOperationException
    implements Serializable
{
    /**
     * <p>
     * Creates a new SuperBlockSecurityException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     SuperBlockSecurityException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public SuperBlockSecurityException (
    ...
    /**
     * <p>
     * Creates a new SuperBlockSecurityException with the specified Message.
     * </p>
     *
     * @param message The Message for this SuperBlockSecurityException.
    ...
    /**
     * <p>
     * Creates a new SuperBlockSecurityException with the specified String text.
     * </p>
     *
     * @param text The text for this SuperBlockSecurityException.
     *             The localized Message will be looked up by Locale
