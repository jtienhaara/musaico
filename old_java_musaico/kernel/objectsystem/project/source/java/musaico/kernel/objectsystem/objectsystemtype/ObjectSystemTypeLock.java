...
/**
 * <p>
 * A lock which throws an ObjectSystemTypeException if it times
 * out waiting for mutually exclusive access to something(s).
 * </p>
 *
 * <p>
 * Useful for implementing the operations for ObjectSystemTypes.
 * </p>
 *
 * @see musaico.mutex
 *
 ...
 * </pre>
 */
public class ObjectSystemTypeLock
    implements Serializable
{
    ...
    /**
     * <p>
     * Creates a new ObjectSystemTypeLock on the specified mutexes.
     * </p>
     *
        ...
        throws I18nIllegalArgumentException
    {
        if ( mutexes == null )
        {
            throw new I18nIllegalArgumentException ( "Cannot create a [%lock_type%] on mutexes [%mutexes%]",
     ...
     */
    public void lock ()
        throws ObjectSystemTypeException
    {
        ...
        throws ObjectSystemTypeException
    {
        ...
        {
            throw new ObjectSystemTypeException ( "Failed to acquire lock on [%mutexes%] in [%timeout_in_milliseconds%] milliseconds",
