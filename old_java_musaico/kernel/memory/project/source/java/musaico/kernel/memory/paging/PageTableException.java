...
/**
 * <p>
 * An exception thrown by a page table, for example when a
 * requested Position is not present in the page table.
 * </p>
 *
 *
 * <p>
 ...
 * </pre>
 */
public class PageTableException
    extends SwapException
    implements Serializable
{
    /**
     * <p>
     * Creates a new PageTableException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     PageTableException.  The
     *                     localized Message will be looked up by
     *                     Locale when requested. Must not be null.
     */
    public PageTableException (
    ...
    /**
     * <p>
     * Creates a new PageTableException with the specified Message.
     * </p>
     *
     * @param message The Message for this PageTableException.
    ...
    /**
     * <p>
     * Creates a new PageTableException with the
     * specified String text.
     * </p>
     *
     * @param text The text for this PageTableException.
     *             The localized Message will be looked up by Locale
