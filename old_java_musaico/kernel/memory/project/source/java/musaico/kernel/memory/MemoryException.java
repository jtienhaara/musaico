...
/**
 * <p>
 * An exception thrown by some sort of memory operation, such
 * as operating on a segment or swapping a page in, and so on.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new MemoryException with the specified
     ...
     * </p>
     *
     * @param message The Message for this MemoryException.
    ...
    /**
     * <p>
     * Creates a new MemoryException with the
     * specified String text.
     * </p>
     *
     * @param text The text for this MemoryException.
     *             The localized Message will be looked up by Locale
