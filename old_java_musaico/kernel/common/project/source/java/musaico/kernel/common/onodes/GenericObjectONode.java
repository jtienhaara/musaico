...
/**
 * <p>
 * An hierarchical object ONode, with child ONodes, which does the
 ...
 * </pre>
 */
public class GenericObjectONode
    extends GenericFlatONode
    implements ObjectONode, Serializable
{
    ...
    /**
     * <p>
     * Creates a new GenericObjectONode with the specified parameters.
     * </p>
     *
     * <p>
    ...
    {
        this.module.traceEnter ( "GenericObjectONode.lookup()" );

        this.module.traceFail ( "GenericObjectONode.lookup()" );
    ...
    public void truncate (
        ...
        throws ONodeOperationException
    {
        this.module.traceEnter ( "GenericObjectONode.truncate()" );

        // This ONode does not allow truncating.
        this.module.traceFail ( "GenericObjectONode.truncate()" );
