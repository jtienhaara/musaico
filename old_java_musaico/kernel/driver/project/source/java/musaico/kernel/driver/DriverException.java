...
/**
 * <p>
 * An exception thrown by some sort of driver operation, such
 * as reading from a driver or writing to it, opening or closing
 * a driver, and so on.
 * </p>
 *
 *
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new DriverException with the specified
     ...
     * </p>
     *
     * @param message The Message for this DriverException.
    ...
    /**
     * <p>
     * Creates a new DriverException with the
     * specified String text.
     * </p>
     *
     * @param text The text for this DriverException.
     *             The localized Message will be looked up by Locale
