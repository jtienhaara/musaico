...
/**
 * <p>
 * An exception thrown by a driver when a transaction is unfinished
 * or in an incorrect state, such as closing a Cursor in the middle
 * of a transaction, or committing a transaction without first
 * preparing to commit.
 * </p>
 *
 *
    ...
    implements Serializable
{
    /**
     * <p>
     * Creates a new TransactionException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     TransactionException.  The
     *                     localized Message will be looked up by
     *                     Locale when requested. Must not be null.
     */
    ...
    /**
     * <p>
     * Creates a new TransactionException with the specified Message.
     * </p>
     *
     * @param message The Message for this TransactionException.
    ...
    /**
     * <p>
     * Creates a new TransactionException with the
     * specified String text.
     * </p>
     *
     * @param text The text for this TransactionException.
     *             The localized Message will be looked up by Locale
