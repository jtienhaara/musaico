...
/**
 * <p>
 * An exception thrown during or between executions of a Task,
 * entirely unrelated to the Task but which caused it to be
 * un-scheduled and its <code> cleanUp () </code> method invoked.
 * </p>
 *
 * <p>
 * For example, if the scheduler falls over on its own bug
 * before a Task has finished executing according to its
 * schedule, then the scheduler might invoke
 * <code> task.cleanUp ( new ExternalScheduleException ( "Scheduler failed..." ) ) </code>
 * or something similar in order to clean up the task's
 * environment.
 * </p>
 *
 *
 ...
 * </pre>
 */
public class ExternalScheduleException
    extends ScheduleException
    implements Serializable
{
    /**
     * <p>
     * Creates a new ExternalScheduleException with the specified
     * internationalized Message.
     * </p>
     *
     * @param i18n_message The internationalized Message for this
     *                     ExternalScheduleException.  The localized Message
     *                     will be looked up by Locale when requested.
     *                     Must not be null.
     */
    public ExternalScheduleException (
    ...
    /**
     * <p>
     * Creates a new ExternalScheduleException with the specified Message.
     * </p>
     *
     * @param message The Message for this ExternalScheduleException.
    ...
    /**
     * <p>
     * Creates a new ExternalScheduleException with the specified String text.
     * </p>
     *
     * @param text The text for this ExternalScheduleException.
     *             The localized Message will be looked up by Locale
