    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Union operation with the default name.
     * </p>
     */
    public Union ()
    {
        this ( TopologyTypeClass.RegionClass.UNION.name () );
    }


    /**
     * <p>
     * Creates a new Union operation with the specified name.
     * </p>
     *
     ...
     * </p>
     *
     * @param region1 The 1st Region to union.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to union.
     *                Must not be null.
     *
     * @return The union of the two specified Regions.
