    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Difference operation with the default name.
     * </p>
     */
    public Difference ()
    {
        this ( TopologyTypeClass.RegionClass.DIFFERENCE.name () );
    }


    /**
     * <p>
     * Creates a new Difference operation with the specified name.
     * </p>
     *
                                             ...
                                             )
    {
                ...
                || input2.hasNext () )
        {
            ...
            {
                output = this.difference ( input1.next (),
                                           input2.next () );
            }
    ...
    /**
     * <p>
     * Returns the difference of two Regions.
     * </p>
     *
     * @param region1 The 1st Region to difference.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to difference.
     *                Must not be null.
     *
     * @return The difference of the two specified Regions.
