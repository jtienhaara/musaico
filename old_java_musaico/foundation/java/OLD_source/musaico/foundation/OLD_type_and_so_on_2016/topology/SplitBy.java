    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new SplitBy operation with the default name.
     * </p>
     */
    public SplitBy ()
    {
        this ( TopologyTypeClass.RegionClass.SPLIT_BY.name () );
    }


    /**
     * <p>
     * Creates a new SplitBy operation with the specified name.
     * </p>
     *
                                             ...
                                             )
    {
                ...
                || input2.hasNext () )
        {
            ...
            {
                output = this.splitBy ( input1.next (),
                                        input2.next () );
            }
    ...
    /**
     * <p>
     * Returns the split by of two Regions.
     * </p>
     *
     * @param region1 The 1st Region to split by.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to split by.
     *                Must not be null.
     *
     * @return The split by of the two specified Regions.
     *         Can be empty.  Never null.
     */
    public Region splitBy (
                           Region region1,
                           Region region2
                           )
    {
