package musaico.foundation.transaction;
...
/**
 * <p>
 * Module settings for the musaico.foundation.transaction module.
 * </p>
 *
 *
 * <p>
 ...
 * </p>
 *
 * @see musaico.foundation.transaction.MODULE#COPYRIGHT
 * @see musaico.foundation.transaction.MODULE#LICENSE
 */
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Transactions are sequences of instructions (transitions between states) which are intended to be executed, akin to compiled programs intended for execution by a CPU.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x1464F8782FB3D08DD08B1F2EB2937C3C47E6B810";
    ...
    static final long VERSION = 20160210L;
