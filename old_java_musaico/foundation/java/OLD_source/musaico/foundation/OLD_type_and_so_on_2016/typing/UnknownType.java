...
/**
 * <p>
 * An as yet unresolved (free variable) Type.
 * </p>
 *
 * <p>
...
public class UnknownType
    implements Type<Object>, Serializable
{
    ...
    private static final ObjectContracts classContracts =
        new ObjectContracts ( UnknownType.class );

    // None value for UnknownType.
    private static final Object NONE = "Unknown.NONE";


    // Checks method obligations and guarantees, and tracks violations.
    private final TrackingContracts contracts;

    // The unique identifier for this UnknownType.
    private final TypeID id;

    // The SymbolTable containing any child Types, Constraints,
    // Operations, and so on for this UnknownType, as well
    // as the parent Namespace and so on ancestors.
    private final SymbolTable symbolTable;

    // The Metadata for this UnknownType.
    private final Metadata metadata;

    // The contract violation for no values and so on.
    private final TypeMustNotBeUnknown.Violation violation;
     ...
     *                         UnknownType is being created.
     *                         The parent Namespace is used, for example,
     *                         to look up the Type corresponding to a Class.
     *                         Must not be null.
     *
     * @param type_name The name of this new UnknownType.  The name will be
     *                  used to create a SymbolID for this UnknownType.
     ...
     *                  For example, "notype".  Must not be null.
     *
     * @param metadata The Metadata for this UnknownType.
    ...
    /**
     * <p>
     * For use by <code> UnknownType.rename ( ... ) </code> only.
     * </p>
     */
    private UnknownType (
                         Namespace parent_namespace,
                         ...
                         )
    {
        classContracts.check ( ParametersMustNotBeNull.CONTRACT,
                               type_name, metadata, symbol_table );
        ...
        this.violation =
            TypeMustNotBeUnknown.CONTRACT.violation ( this, this );
     ...
     */
    @Override
    public NoTypedValueBuilder<Object> builder ()
    {
        return new NoTypedValueBuilder<Object> ( this, this.violation );
    }
               ...
               ReturnNeverNull.Violation
    {
        ...
        return new Error<Object> ( Object.class,
                                   violation );
    }
                                 ...
                                 )
    {
        ...
        final UnknownType that = (UnknownType) object;
               ...
               ReturnNeverNull.Violation
    {
        ...
        return new Constant<Object> ( this,
        ...
        throws ParametersMustNotBeNull.Violation
    {
        ...
        try
        {
            this.checkValue ( (Value<Object>) value );
        ...
        {
            // Probably a derived UnknownType implementation.
    ...
    public final <VIOLATION extends Throwable & Violation>
        ...
        throws ReturnNeverNull.Violation
    {
        return new No<Object> ( this.valueClass (),
                                this.violation );
    }
               ...
               ReturnNeverNull.Violation
    {
        ...
        return new No<Object> ( Object.class,
                                violation );
    }
               ...
               ReturnNeverNull.Violation
    {
        ...
        return new UnknownType ( parent_namespace,
                                 name,
                                 this.metadata ().renew (),
                                 symbol_table );
    }
     ...
     */
    @Override
    public ZeroOrOne<Type<Object>> sub (
                                        Tag ... tags
                                        )
        throws ParametersMustNotBeNull.Violation,
               ...
               ReturnNeverNull.Violation
    {
        ...
        // Can't add Tags to a UnknownType.
        return TypeBuilder.createNoUnknownType ( this );
    }
               ...
               ReturnNeverNull.Violation
    {
        ...
        return new NoCast<Object, TO> ( this, that, this.violation );
    }
    ...
    /**
     * @return The contract Violation which led to this UnknownType.
     *         Never null.
     */
