...
/**
 * <p>
 * The Type describing an Unknown.
 * </p>
 *
 * <p>
 * An UnknownTermType describes the actual Unknown, and
 * its <code> valueType () </code> describes the value Type of
 * the Unknown, such as a string Type, or an integer Type, and so on.
 * </p>
 *
 *
 * <p>
 ...
 */
public class UnknownTermType<VALUE extends Object>
    extends AbstractTermType<Unknown<VALUE>, VALUE>
    implements Serializable
{
    ...
    private static final ObjectContracts classContracts =
        new ObjectContracts ( UnknownTermType.class );


    /**
     * <p>
     * Generates the "none" Unknown for an UnknownTermType, avoiding infinite
     * recursion at constructor time.
     * </p>
     */
    public static class NoneUnknownTermGenerator<NONE_VALUE extends Object>
        implements NoneGenerator<Unknown<NONE_VALUE>>, Serializable
    {
        private static final long serialVersionUID =
            UnknownTermType.serialVersionUID;

        // Lock critical sections on this token:
        private final Serializable lock = new String ();

        // The value Type for Unknowns of this UnknownTermType.
        private final Type<NONE_VALUE> valueType;

        // Generated once, return the same value after that.
        // MUTABLE.
        private Unknown<NONE_VALUE> none = null;


        /**
         * <p>
         * Creates a new NoneGenerator for an UnknownTermType.
         * </p>
         *
         * @param value_type The value Type of the UnknownTermType.
         *                   Used to create the "none" value for the
         *                   "none" Unknown.  Must not be null.
         */
        public NoneUnknownTermGenerator (
         ...
         */
        public final Unknown<NONE_VALUE> none ()
            throws ReturnNeverNull.Violation
        {
            synchronized ( this.lock )
            {
                if ( this.none == null )
                {
                    this.none = new Unknown<NONE_VALUE> ( this.valueType );
                }
    ...
    /**
     * <p>
     * Creates a new UnknownTermType with the specified value Type,
     * an empty SymbolTable, and StandardMetadata,
     * with an automatically generated name for this new
     * UnknownTermType.
     * </p>
     *
     * @param value_type The Type of Value for each Unknown
     ...
     *                     Must not be null.
     *
     * @param metadata The Metadata for this UnknownTermType.
    ...
    UnknownTermType (
        ...
        throws ParametersMustNotBeNull.Violation
    {
        this ( "unknown(" + value_type.id ().name () + ")",
               value_type,
               symbol_table,
               metadata );
    }
    ...
    /**
     * <p>
     * Creates a new UnknownTermType with the specified type name,
    ...
    {
        super ( raw_type_name,
                new UnknownTermType.NoneUnknownTermGenerator<VALUE> ( value_type ),
                value_type,
                symbol_table,
                metadata );
    }
     ...
     */
    @Override
    public final UnknownTermType<VALUE> rename (
                                                String name
                                                )
        throws ParametersMustNotBeNull.Violation,
     ...
     */
    @Override
    public UnknownTermType<VALUE> rename (
                                          String name,
                                          SymbolTable symbol_table
                                          )
        throws ParametersMustNotBeNull.Violation,
               ReturnNeverNull.Violation
    {
        ...
        return new UnknownTermType<VALUE> ( name,
                                            this.valueType (),
                                            symbol_table,
                                            this.metadata ().renew () );
    }
    ...
    private static class Silly<TERM_CLASS>
    {
        ...
        {
            return (Class<TERM_CLASS>) Unknown.class;
        }
    }
     ...
     */
    @Override
    public final Class<Unknown<VALUE>> valueClass ()
        throws ReturnNeverNull.Violation
    {
        return new Silly<Unknown<VALUE>> ().getTermClass ();
    }
}
