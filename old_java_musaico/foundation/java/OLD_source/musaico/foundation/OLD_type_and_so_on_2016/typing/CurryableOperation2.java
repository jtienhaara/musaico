...
/**
 * <p>
 * A curryable Operation which takes 2 inputs.
 * </p>
 *
 *
 * <br> </br>
 ...
 */
public interface CurryableOperation2<INPUT1 extends Object, INPUT2 extends Object, OUTPUT extends Object>
    extends Operation2<INPUT1, INPUT2, OUTPUT>
{
     ...
     *         input(s) actually evaluates this Operation2 with all inputs.
     *         Never null.
     *
     * @see musaico.foundation.typing.Operation2#evaluate(musaico.foundation.value.Value, musaico.foundation.value.Value)
     */
    public abstract ZeroOrOne<Operation1<INPUT2, OUTPUT>> evaluate (
                                                                    Value<INPUT1> input1
                                                                    )
