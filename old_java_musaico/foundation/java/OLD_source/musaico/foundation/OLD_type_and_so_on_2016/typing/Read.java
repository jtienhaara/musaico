...
/**
 * <p>
 * The default "read" Operation for Types.  Returns the input parameter
 * as-is.
 * </p>
 *
 * <p>
 * Some Types, and especially certain Tags, might want to mutate the
 * Read Operation to protect private data, or encrypt confidential
 * values, and so on.  So typically it is good for every Type to
 * have the default Read Operation in its SymbolTable.
 * </p>
 *
 * <p>
 * Every read operation must always return only NonBlocking Values.
 * </p>
 *
 *
 * <p>
    ...
    implements Operation1<VALUE, VALUE>, OperationBody1<VALUE, VALUE>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Read operation to return inputs as-is, with
     * the default OperationID "read".
     * </p>
     *
     * @param type The Type of values input to and output from this Read.
     *             Must not be null.
     */
    public Read (
                 Type<VALUE> type
    ...
    /**
     * <p>
     * Creates a new Read operation to return inputs, optionally
     ...
     *                      value to be read.  Must always return NonBlocking
     *                      Values.  Can be null, if this Read Operation
    ...
    /**
     * <p>
     * Creates a new Read operation to return inputs as-is.
     * </p>
     *
     * @param name The name of this Read, which will be used to
     ...
     * </p>
     *
     * @param id The Operation identifier for this Read, which
