...
/**
 * <p>
 * Module settings for the musaico.foundation.typing.requirement module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String COPYRIGHT =
        "Copyright (c) 2014-2018 Johann Tienhaara <jtienhaara@yahoo.com>";

    /** Human-readable description of the purpose of this module. */
    private static final String DESCRIPTION =
        "A locking an unlocking mechanism which can be used to secure Values, for example by requiring a password to retrieve the contents of a Value.  All requirements must be met before the contents of a Value will be returned to the user.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x34E24AF05DDDF6C0D01321E715F482B7CD9B8231";
