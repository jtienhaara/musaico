...
/**
 * <p>
 * Grants a specific set of capabilities to any who request them.
 * </p>
 *
 *
 * <p>
    ...
    implements SecurityPolicy, Serializable
{
    ...
    private static final ObjectContracts classContracts =
        new ObjectContracts ( Grant.class );


    /** Checks contracts on methods for us. */
    private final ObjectContracts contracts;

    /** The capabilities to grant. */
    private final Set<Capability> capabilities;

    /** The security contract for violations (whenever a capability
     *  that is requested is not explicitly part of this grant). */
    private final SecurityContract securityContract;


    /**
     * <p>
     * Creates a new Grant to grant the specified Capabilities,
     * and only the specified Capabilities.
     * </p>
     *
     * @param capabilities The capabilities to grant whenever requested.
    ...
    /**
     * <p>
     * Returns the capabilities granted by this policy, including all
     * implied capabilities.
     * </p>
     *
     * @return The Capabilities granted by this policy.  Never null.
                           ...
                           )
    {
        ...
        {
            // GrantA != Foo or GrantB.
            return false;
        }

        Grant that = (Grant) object;
