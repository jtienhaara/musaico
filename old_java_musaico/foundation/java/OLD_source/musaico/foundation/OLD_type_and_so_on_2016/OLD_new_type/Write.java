...
import musaico.foundation.value.ValueMustBeNonBlocking;


/**
 * <p>
 * The default "write" Operation for Types.  Returns the input parameter
 * as-is.
 * </p>
 *
 * <p>
 * Some Types, and especially certain Tags, might want to mutate the
 * Write Operation to protect private data, or encrypt confidential
 * values, and so on.  So typically it is good for every Type to
 * have the default Write Operation in its SymbolTable.
 * </p>
 *
 * <p>
 * Every write operation must always return only NonBlocking Values.
 * </p>
 *
 *
 * <p>
...
public class Write<VALUE extends Object>
    ...
    implements Operation1<VALUE, VALUE>, OperationBody1<VALUE, VALUE>, Serializable
{
    ...
    // Pre-processes every input we write.  Can be null.
    private final Operation1<VALUE, VALUE> preProcessor;


    /**
     * <p>
     * Creates a new Write operation to return inputs as-is, with
     * the default OperationID "write".
     * </p>
     *
     * @param type The Type of values input to and output from this Write.
     *             Must not be null.
     */
    public Write (
                  Type<VALUE> type
    ...
    {
        this ( "write", type, null ); // No pre_processor.
    }


    /**
     * <p>
     * Creates a new Write operation to return inputs, optionally
     ...
     *                      value to be write.  Must always return NonBlocking
     *                      Values.  Can be null, if this Write Operation
     *                      has no pre-processors.  Can be null.
     */
    public Write (
                  Type<VALUE> type,
    ...
    /**
     * <p>
     * Creates a new Write operation to return inputs as-is.
     * </p>
     *
     * @param name The name of this Write, which will be used to
     ...
     * </p>
     *
     * @param id The Operation identifier for this Write, which
     ...
     */
    @Override
    public final NonBlocking<VALUE> evaluateBody (
                                                  Value<VALUE> processed_input
                                                  )
    {
        if ( processed_input instanceof NonBlocking )
        {
            return (NonBlocking<VALUE>) processed_input;
        }
     ...
     */
    @Override
    public final NonBlocking<VALUE> evaluate (
                                              Value<VALUE> input
                                              )
        throws ParametersMustNotBeNull.Violation
    {
        ...
        final NonBlocking<VALUE> output;
        try
        {
