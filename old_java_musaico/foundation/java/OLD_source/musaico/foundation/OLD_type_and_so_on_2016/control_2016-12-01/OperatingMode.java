...
/**
 * <p>
 * How to run the controllable processor, such as once only, as a server
 * listening for Control messages, as a task which recurs at periodic
 * intervals, and so on.
 * </p>
 *
 * <p>
 * In Java, every OperatingMode must be Serializable in order
 ...
 */
public class OperatingMode<PARAMETERS extends Serializable>
    extends Mode
    implements Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( OperatingMode.class );
