...
/**
 * <p>
 * Module settings for the musaico.foundation.value.control module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "A set of remote control-type commands, which are designed to provide simple start-stop, give-me-data, subscribe and unsubscribe and so on messaging between a controller and a controllee, where the controller and the controllee might or might not be on the same machine or written in the same programming language and so on.";
