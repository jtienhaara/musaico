...
Number evidence
    ...
    public static class MustBeInstanceOfClass
        implements Contract<Object, Parameter1.MustBeInstanceOfClass.Violation>, Serializable
    {
        private static final long serialVersionUID =
            Parameter1.serialVersionUID;
        ...
        @Override
        public Parameter1.MustBeInstanceOfClass.Violation violation (
                Object plaintiff,
                Object evidence
                )
        {
            return new Parameter1.MustBeInstanceOfClass.Violation (
                this,
                plaintiff,
                evidence );
        }
        ...
        {
            final Parameter1.MustBeInstanceOfClass.Violation violation =
                this.violation ( plaintiff, evidence );
            if ( cause != null )
            {
                violation.initCause ( cause );
    ...
    public static class MustNotBeInstanceOfClass
        implements Contract<Object, Parameter1.MustNotBeInstanceOfClass.Violation>, Serializable
    {
        private static final long serialVersionUID =
            Parameter1.serialVersionUID;
        ...
        @Override
        public Parameter1.MustNotBeInstanceOfClass.Violation violation (
                Object plaintiff,
                Object evidence
                )
        {
            return new Parameter1.MustNotBeInstanceOfClass.Violation (
                this,
                plaintiff,
                evidence );
        }
        ...
        {
            final Parameter1.MustNotBeInstanceOfClass.Violation violation =
                this.violation ( plaintiff, evidence );
            if ( cause != null )
            {
                violation.initCause ( cause );
