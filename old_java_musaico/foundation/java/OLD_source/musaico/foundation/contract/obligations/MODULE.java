...
/**
 * <p>
 * Module settings for the musaico.foundation.contract.obligations module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Requirements that the user of an object must meet, such as domains of acceptable input values.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xDC57E3247AE47215C8D96535B4BAFB35D72B073F";
    ...
    static final long VERSION = 20170908L;
