...
/**
 * <p>
 * Module settings for the musaico.foundation.capability.permission module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Permission Capabilities for requesting, granting and revoking permissions to other objects to make use of specific Capabilities.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x1C03EE2656260EDE64B61C8FA22F664801181EF4";
    ...
    static final long VERSION = 20170225L;
