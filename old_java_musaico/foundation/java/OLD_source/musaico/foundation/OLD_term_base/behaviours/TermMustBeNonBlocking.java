...
/**
 * <p>
 * A guarantee of a non-blocking term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeNonBlocking
    implements Contract<Term<?>, TermMustBeNonBlocking.Violation>, Serializable
{
    ...
    /** The TermMustBeNonBlocking contract. */
    public static final TermMustBeNonBlocking CONTRACT =
        new TermMustBeNonBlocking ();
    ...
    {
        return "The term must be NonBlocking, so that the recipient"
            + " of the term need not wait to inspect its elements.";
    }
     ...
     */
    @Override
    public TermMustBeNonBlocking.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustBeNonBlocking.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    /**
     * <p>
     * A violation of the TermMustBeNonBlocking contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeNonBlocking.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeNonBlocking.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not NonBlocking.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
