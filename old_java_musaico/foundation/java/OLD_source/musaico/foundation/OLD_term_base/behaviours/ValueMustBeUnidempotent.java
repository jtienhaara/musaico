...
/**
 * <p>
 * A guarantee of a Term with a value that is Unidempotent (can iterate
 * over different elements depending on when the iterator is created).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeUnidempotent
    implements Contract<Term<?>, ValueMustBeUnidempotent.Violation>, Serializable
{
    ...
    /** The ValueMustBeUnidempotent contract. */
    public static final ValueMustBeUnidempotent CONTRACT =
        new ValueMustBeUnidempotent ();
    ...
    {
        return "The term's value must be Unidempotent, so that it might"
            + "contain different elements from one iteration to the next.";
    }
     ...
     */
    @Override
    public ValueMustBeUnidempotent.Violation violation (
                                                        Object plaintiff,
                                                        Term<?> evidence
                                                        )
    {
        return new ValueMustBeUnidempotent.Violation ( this,
                                                       plaintiff,
                                                       evidence );
    }
    ...
    {
        final ValueMustBeUnidempotent.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeUnidempotent contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeUnidempotent.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeUnidempotent.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term's value was not Unidempotent.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
