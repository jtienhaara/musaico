...
/**
 * <p>
 * A guarantee of a Cancelled term, which is a variant of No value caused
 * by some procedure being forcefully aborted before it generate a final
 * result.
 * </p>
 *
 *
 ...
 */
public class TermMustBeCancelled
    implements Contract<Term<?>, TermMustBeCancelled.Violation>, Serializable
{
    ...
    /** The TermMustBeCancelled contract. */
    public static final TermMustBeCancelled CONTRACT =
        new TermMustBeCancelled ();
    ...
    {
        return "The term must be a Cancelled, caused by waiting too"
            + " long for a blocking term to be resolved.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Cancelled )
        {
     ...
     */
    @Override
    public TermMustBeCancelled.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBeCancelled.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final TermMustBeCancelled.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeCancelled contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeCancelled.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeCancelled.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not a Cancelled.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
