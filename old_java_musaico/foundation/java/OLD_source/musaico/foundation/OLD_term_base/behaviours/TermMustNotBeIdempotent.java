...
/**
 * <p>
 * A guarantee of any term except an Idempotent one (that is, a term
 * which will not necessarily iterate through the same elements
 * every time).
 * </p>
 *
 *
 ...
 */
public class TermMustNotBeIdempotent
    implements Contract<Term<?>, TermMustNotBeIdempotent.Violation>, Serializable
{
    ...
    /** The TermMustNotBeIdempotent contract. */
    public static final TermMustNotBeIdempotent CONTRACT =
        new TermMustNotBeIdempotent ();
    ...
    {
        return "The term must not be Idempotent.";
    }
     ...
     */
    @Override
    public TermMustNotBeIdempotent.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotBeIdempotent.Violation ( this,
                                                        plaintiff,
                                                        evidence );
    }
    ...
    {
        final TermMustNotBeIdempotent.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeIdempotent contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeIdempotent.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeIdempotent.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Idempotent.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
