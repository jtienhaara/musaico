...
/**
 * <p>
 * A guarantee of any term except an Immutable term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeImmutable
    implements Contract<Term<?>, TermMustNotBeImmutable.Violation>, Serializable
{
    ...
    /** The TermMustNotBeImmutable contract. */
    public static final TermMustNotBeImmutable CONTRACT =
        new TermMustNotBeImmutable ();
    ...
    {
        return "The term must not be Immutable.";
    }
     ...
     */
    @Override
        public TermMustNotBeImmutable.Violation violation (
                Object plaintiff,
                Term<?> evidence
                )
    {
        return new TermMustNotBeImmutable.Violation ( this,
                                                       plaintiff,
                                                       evidence );
    }
    ...
    {
        final TermMustNotBeImmutable.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeImmutable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeImmutable.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeImmutable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Immutable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
