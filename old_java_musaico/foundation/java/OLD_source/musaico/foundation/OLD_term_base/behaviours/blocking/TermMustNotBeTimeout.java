...
/**
 * <p>
 * A guarantee of any term except a timeout term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeTimeout
    implements Contract<Term<?>, TermMustNotBeTimeout.Violation>, Serializable
{
    ...
    /** The TermMustNotBeTimeout contract. */
    public static final TermMustNotBeTimeout CONTRACT =
        new TermMustNotBeTimeout ();
    ...
    {
        return "The term must not be Timeout.";
    }
     ...
     */
    @Override
    public TermMustNotBeTimeout.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new TermMustNotBeTimeout.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustNotBeTimeout.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeTimeout contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeTimeout.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeTimeout.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Timeout.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
