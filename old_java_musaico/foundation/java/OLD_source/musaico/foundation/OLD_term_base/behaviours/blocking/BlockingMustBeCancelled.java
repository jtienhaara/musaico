...
/**
 * <p>
 * A guarantee that each Blocking term was cancelled.
 * </p>
 *
 *
 * <p>
 ...
 */
public class BlockingMustBeCancelled
    implements Contract<Blocking<?>, BlockingMustBeCancelled.Violation>, Serializable
{
    ...
    public static final BlockingMustBeCancelled CONTRACT =
        new BlockingMustBeCancelled ();


    private BlockingMustBeCancelled ()
    {
    }
    ...
    {
        return "Each Blocking term must have been cancelled.";
    }
     ...
     */
    @Override
    public BlockingMustBeCancelled.Violation violation (
            Object plaintiff,
            Blocking<?> evidence
            )
    {
        return new BlockingMustBeCancelled.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    /**
     * <p>
     * A violation of the BlockingMustBeCancelled contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            BlockingMustBeCancelled.serialVersionUID;


        /**
         * <p>
         * Creates a new BlockingMustBeCancelled.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The specified Blocking term has not been cancelled: "
                    + evidence
                    + ".", // description
                    plaintiff,
                    evidence,
