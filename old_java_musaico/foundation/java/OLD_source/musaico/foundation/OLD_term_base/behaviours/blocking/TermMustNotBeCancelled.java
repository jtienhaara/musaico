...
/**
 * <p>
 * A guarantee of any term except a Cancelled term, which is a variant
 * of No value caused by some procedure being forcefully aborted
 * before it generate a final result.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeCancelled
    implements Contract<Term<?>, TermMustNotBeCancelled.Violation>, Serializable
{
    ...
    /** The TermMustNotBeCancelled contract. */
    public static final TermMustNotBeCancelled CONTRACT =
        new TermMustNotBeCancelled ();
    ...
    {
        return "The term must not be Cancelled.";
    }
     ...
     */
    @Override
    public TermMustNotBeCancelled.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotBeCancelled.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustNotBeCancelled.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeCancelled contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeCancelled.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeCancelled.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Cancelled.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
