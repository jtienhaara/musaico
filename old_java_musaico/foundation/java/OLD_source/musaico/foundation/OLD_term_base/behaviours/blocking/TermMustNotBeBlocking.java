...
/**
 * <p>
 * A guarantee of any term except a blocking term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeBlocking
    implements Contract<Term<?>, TermMustNotBeBlocking.Violation>, Serializable
{
    ...
    /** The TermMustNotBeBlocking contract. */
    public static final TermMustNotBeBlocking CONTRACT =
        new TermMustNotBeBlocking ();
    ...
    {
        return "The term must not be Blocking.";
    }
     ...
     */
    @Override
    public TermMustNotBeBlocking.Violation violation (
                                                       Object plaintiff,
                                                       Term<?> evidence
                                                       )
    {
        return new TermMustNotBeBlocking.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    {
        final TermMustNotBeBlocking.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeBlocking contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeBlocking.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeBlocking.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Blocking.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
