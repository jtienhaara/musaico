...
/**
 * <p>
 * Each Invocation of each Operation must return an output which
 * does NOT meet some other Contract (such as TermMustNotBeEmpty
 * or TermMustBeMultiple and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class OperationOutputMustNotMeet
    implements Contract<Invocation<?, ?>, OperationOutputMustNotMeet.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( OperationOutputMustNotMeet.class );
    ...
    /**
     * <p>
     * Creates a new OperationOutputMustNotMeet(C) contract.
     * </p>
     *
     * @param output_contract The Contract which must NOT be met
     *                        by the output Term of
     *                        each operation Invocation.
     *                        Must not be null.
     */
    @SuppressWarnings("unchecked") // Cast Contract<?,?> - Contract<Obj,?>.
    public OperationOutputMustNotMeet (
                           ...
                           )
    {
        ...
        final OperationOutputMustNotMeet that =
            (OperationOutputMustNotMeet) obj;
     ...
     */
    @Override
    public OperationOutputMustNotMeet.Violation violation (
            Object plaintiff,
            Invocation<?, ?> evidence
            )
    {
        return new OperationOutputMustNotMeet.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final OperationOutputMustNotMeet.Violation violation =
    ...
    /**
     * <p>
     * A violation of the OperationOutputMustNotMeet contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            OperationOutputMustNotMeet.serialVersionUID;


        /**
         * <p>
         * Creates a new OperationOutputMustNotMeet.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          OperationOutputMustNotMeet contract,
                          Object plaintiff,
                          Invocation<?, ?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
