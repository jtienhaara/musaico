...
/**
 * <p>
 * Module settings for the musaico.foundation.operations.select module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "The standard implementation for Select and its related Operations, which can choose ranges of elements or an individual element from a Term.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x39506B5BB98A8C57FF62DEF0D9852470B003EE3E";
    ...
    static final long VERSION = 20161028L;
