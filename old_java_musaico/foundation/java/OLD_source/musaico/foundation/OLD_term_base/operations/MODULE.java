...
/**
 * <p>
 * Module settings for the musaico.foundation.operations module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Tools for manipulating Terms, such as Operations for selection and filtering, sorting and organizing, inserting and appending, searching, and so on.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xB7B67C8113AD0BE1D8D628F1370A8ABAC169A9A4";
