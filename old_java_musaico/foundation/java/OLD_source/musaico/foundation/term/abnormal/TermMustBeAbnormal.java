...
/**
 * <p>
 * A guarantee of an Abnormal term, such as an Error or a Warning.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeAbnormal
    implements Contract<Term<?>, TermMustBeAbnormal.Violation>, Serializable
{
    ...
    /** The TermMustBeAbnormal contract. */
    public static final TermMustBeAbnormal CONTRACT =
        new TermMustBeAbnormal ();
    ...
    {
        return "The term must be Abnormal, such as an error or a"
            + " warning or some other exceptional term.";
    }
     ...
     */
    @Override
    public TermMustBeAbnormal.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new TermMustBeAbnormal.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final TermMustBeAbnormal.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeAbnormal contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeAbnormal.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeAbnormal.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Abnormal.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
