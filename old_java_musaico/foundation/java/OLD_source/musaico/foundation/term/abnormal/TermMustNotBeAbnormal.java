...
/**
 * <p>
 * A guarantee of any value EXCEPT an abnormal one (Error, Warning,
 * and so on), even possibly an Unjust term such as No or Partial.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeAbnormal
    implements Contract<Term<?>, TermMustNotBeAbnormal.Violation>, Serializable
{
    ...
    /** The TermMustNotBeAbnormal contract. */
    public static final TermMustNotBeAbnormal CONTRACT =
        new TermMustNotBeAbnormal ();
    ...
    {
        return "The term must not be Abnormal.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Abnormal )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public TermMustNotBeAbnormal.Violation violation (
                                                       Object plaintiff,
                                                       Term<?> evidence
                                                       )
    {
        return new TermMustNotBeAbnormal.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    {
        final TermMustNotBeAbnormal.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeAbnormal contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeAbnormal.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeAbnormal.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Abnormal.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
