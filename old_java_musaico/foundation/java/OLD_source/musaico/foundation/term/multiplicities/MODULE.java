...
/**
 * <p>
 * Module settings for the musaico.foundation.term.multiplicities module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Varieties of Multiplicity, each of which represents a different number of elements of a value (such as 0, 1, less than 1, infinite, and so on).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xECAA1BF42BFDE898681017D912E15F318E68DE36";
    ...
    static final long VERSION = 20170409L;
