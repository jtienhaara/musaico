...
/**
 * <p>
 * Module settings for the musaico.foundation.term module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Provides conditional values (No, One, Many) and other types of terms (Expressions, Blocking, Errors, Timeouts) with which the user chooses how to handle various unusual scenarios (nulls, exceptions, partial results, infinite results, blocking, and so on).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xC8413D1C238BFBCB63A17715624E1B54734AC656";
    ...
    static final long VERSION = 20170807L;
