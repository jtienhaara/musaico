...
/**
 * <p>
 * A guarantee of an Expression (a Term piped through one
 * or more Operations).
 * </p>
 *
 *
 ...
 */
public class TermMustBeExpression
    implements Contract<Term<?>, TermMustBeExpression.Violation>, Serializable
{
    ...
    /** The TermMustBeExpression contract. */
    public static final TermMustBeExpression CONTRACT =
        new TermMustBeExpression ();
    ...
    {
        return "The term must be an Expression, waiting to perform one"
            + " or more operation(s) on some other term.";
    }
     ...
     */
    @Override
    public TermMustBeExpression.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustBeExpression.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TermMustBeExpression.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeExpression contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeExpression.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeExpression.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not an Expression.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
