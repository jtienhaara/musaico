...
/**
 * <p>
 * A guarantee of anything but an Expression (a Term piped through one
 * or more Operations).
 * </p>
 *
 *
 ...
 */
public class TermMustNotBeExpression
    implements Contract<Term<?>, TermMustNotBeExpression.Violation>, Serializable
{
    ...
    /** The TermMustNotBeExpression contract. */
    public static final TermMustNotBeExpression CONTRACT =
        new TermMustNotBeExpression ();
    ...
    {
        return "The term must not be an Expression (a term piped"
            + " through one or more operation(s)).";
    }
     ...
     */
    @Override
    public TermMustNotBeExpression.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new TermMustNotBeExpression.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final TermMustNotBeExpression.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeExpression contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeExpression.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeExpression.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was an Expression.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
