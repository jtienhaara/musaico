...
/**
 * <p>
 * Module settings for the musaico.foundation.term.expression module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Expressions, each of which encapsulates the output of a Term through one or more Operation(s), and is guaranteed to produce a result (though that result might, itself, be incomplete).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x5DE2CF1C6CC84F0DDC76320EB280FFDBB2C51838";
