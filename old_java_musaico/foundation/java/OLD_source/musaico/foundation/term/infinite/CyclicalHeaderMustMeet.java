...
/**
 * <p>
 * A guarantee that every Cyclical Term's <code> header () </code>
 ...
 */
public class CyclicalHeaderMustMeet
    implements Contract<Term<?>, CyclicalHeaderMustMeet.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( CyclicalHeaderMustMeet.class );


    // The child Contract used to check that each Cyclical header
    // meets this Contract.
    ...
    {
        return "The header of each Cyclical term must meet: "
            + this.childContract;
    }
            ...
            )
    {
        ...
        final CyclicalHeaderMustMeet that = (CyclicalHeaderMustMeet) obj;
            ...
            )
    {
        ...
        final Countable<?> header = cyclical.header ();
        FilterState filter_state =
            this.childContract.filter ( header );
     ...
     */
    @Override
    public CyclicalHeaderMustMeet.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new CyclicalHeaderMustMeet.Violation (
                       this,
                       plaintiff,
                       evidence );
    }
    ...
    {
        final CyclicalHeaderMustMeet.Violation violation =
    ...
    /**
     * <p>
     * A violation of the CyclicalHeaderMustMeet contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            CyclicalHeaderMustMeet.serialVersionUID;


        /**
         * <p>
         * Creates a new CyclicalHeaderMustMeet.Violation.
         * </p>
         *
            ...
            throws ParametersMustNotBeNull.Violation
        {
            super ( contract,
                    ...
                    + " the Cyclical header Contract.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
