...
/**
 * <p>
 * A guarantee of a cyclical infinite-valued term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeCyclical
    implements Contract<Term<?>, TermMustBeCyclical.Violation>, Serializable
{
    ...
    /** The TermMustBeCyclical contract. */
    public static final TermMustBeCyclical CONTRACT =
        new TermMustBeCyclical ();
    ...
    {
        return "The term must be Cyclical, an infinite sequence"
            + " of elements comprising one finite sub-sequence which"
            + " recurs infinitely.";
    }
     ...
     */
    @Override
    public TermMustBeCyclical.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new TermMustBeCyclical.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final TermMustBeCyclical.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeCyclical contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeCyclical.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeCyclical.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Cyclical.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
