...
/**
 * <p>
 * A guarantee of an acyclical infinite-valued term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeAcyclical
    implements Contract<Term<?>, TermMustBeAcyclical.Violation>, Serializable
{
    ...
    /** The TermMustBeAcyclical contract. */
    public static final TermMustBeAcyclical CONTRACT =
        new TermMustBeAcyclical ();
    ...
    {
        return "The term must be Acyclical, an infinite sequence of"
            + " elements with no recurring pattern.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Acyclical )
        {
     ...
     */
    @Override
    public TermMustBeAcyclical.Violation violation (
                                                     Object plaintiff,
                                                     Term<?> evidence
                                                     )
    {
        return new TermMustBeAcyclical.Violation ( this,
                                                    plaintiff,
                                                    evidence );
    }
    ...
    {
        final TermMustBeAcyclical.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeAcyclical contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeAcyclical.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeAcyclical.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Acyclical.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
