...
/**
 * <p>
 * A guarantee of a Term with Continuous values (not discrete elements),
 ...
 */
public class ValueMustBeContinuous
    implements Contract<Term<?>, ValueMustBeContinuous.Violation>, Serializable
{
    ...
    /** The ValueMustBeContinuous contract. */
    public static final ValueMustBeContinuous CONTRACT =
        new ValueMustBeContinuous ();
    ...
    {
        return "The term must have Continuous (non-discrete) values.";
    }
     ...
     */
    @Override
    public ValueMustBeContinuous.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustBeContinuous.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    {
        final ValueMustBeContinuous.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeContinuous contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeContinuous.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeContinuous.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Continuous.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
