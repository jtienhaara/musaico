...
/**
 * <p>
 * Module settings for the musaico.foundation.term.builder module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Helpers which build up each Term one element at a time.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x8A126C8F888296D214DF9DF8F58F7B27CBE2DD7D";
    ...
    static final long VERSION = 20170416L;
