...
/**
 * <p>
 * A guarantee of anything but Many values (allowing One or Some
 ...
 */
public class ValueMustNotBeMany
    implements Contract<Term<?>, ValueMustNotBeMany.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeMany contract. */
    public static final ValueMustNotBeMany CONTRACT =
        new ValueMustNotBeMany ();
    ...
    {
        return "The term must not be Many.";
    }
     ...
     */
    @Override
    public ValueMustNotBeMany.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new ValueMustNotBeMany.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final ValueMustNotBeMany.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeMany contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeMany.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeMany.Violation.
         * </p>
         *
