 ...
 */
public class ValueMustBeNo
    implements Contract<Term<?>, ValueMustBeNo.Violation>, Serializable
{
    ...
    /** The ValueMustBeNo contract. */
    public static final ValueMustBeNo CONTRACT =
        new ValueMustBeNo ();
    ...
    {
        return "The term must be No, a result which contains"
     ...
     */
    @Override
    public ValueMustBeNo.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new ValueMustBeNo.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final ValueMustBeNo.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeNo contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeNo.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeNo.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not No.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
