 ...
 */
public class ValueMustBeMany
    implements Contract<Term<?>, ValueMustBeMany.Violation>, Serializable
{
    ...
    /** The ValueMustBeMany contract. */
    public static final ValueMustBeMany CONTRACT =
        new ValueMustBeMany ();
    ...
    {
        return "The term must be Many, a result which contains"
     ...
     */
    @Override
    public ValueMustBeMany.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new ValueMustBeMany.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final ValueMustBeMany.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeMany contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeMany.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeMany.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Many.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
