...
/**
 * <p>
 * A guarantee of a Term with an Infinite value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeInfinite
    implements Contract<Term<?>, ValueMustBeInfinite.Violation>, Serializable
{
    ...
    /** The ValueMustBeInfinite contract. */
    public static final ValueMustBeInfinite CONTRACT =
        new ValueMustBeInfinite ();
    ...
    {
        return "The term must be Infinite, containing an infinite"
            + " number of elements.";
    }
     ...
     */
    @Override
    public ValueMustBeInfinite.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new ValueMustBeInfinite.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final ValueMustBeInfinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeInfinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeInfinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeInfinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Infinite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
