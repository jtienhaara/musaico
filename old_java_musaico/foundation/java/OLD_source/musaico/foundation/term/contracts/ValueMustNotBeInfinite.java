...
/**
 * <p>
 * A guarantee of any term except an infinite value.
 * </p>
 *
 * <p>
 * Note that an Indefinite value could turn out to contain infinitely
 * many elements, but it is still not an Infinite term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeInfinite
    implements Contract<Term<?>, ValueMustNotBeInfinite.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeInfinite contract. */
    public static final ValueMustNotBeInfinite CONTRACT =
        new ValueMustNotBeInfinite ();
    ...
    {
        return "The term must not be Infinite.";
    }
            ...
            )
    {
        ...
        else if ( term instanceof Infinite )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public ValueMustNotBeInfinite.Violation violation (
                                                       Object plaintiff,
                                                       Term<?> evidence
                                                       )
    {
        return new ValueMustNotBeInfinite.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    {
        final ValueMustNotBeInfinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeInfinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeInfinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeInfinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Infinite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
