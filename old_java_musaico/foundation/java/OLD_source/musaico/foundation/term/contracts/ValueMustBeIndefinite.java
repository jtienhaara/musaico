...
/**
 * <p>
 * A guarantee of a Term with an Indefinite value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeIndefinite
    implements Contract<Term<?>, ValueMustBeIndefinite.Violation>, Serializable
{
    ...
    /** The ValueMustBeIndefinite contract. */
    public static final ValueMustBeIndefinite CONTRACT =
        new ValueMustBeIndefinite ();
    ...
    {
        return "The term must be Indefinite, so that the number"
            + "of elements is unknown in advance.";
    }
     ...
     */
    @Override
    public ValueMustBeIndefinite.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new ValueMustBeIndefinite.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final ValueMustBeIndefinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeIndefinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeIndefinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeIndefinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Indefinite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
