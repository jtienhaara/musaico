...
/**
 * <p>
 * A general-purpose Contract for Terms: each Term's whole value
 * (NOT the term itself, nor the value's elements) must NOT belong
 * to a specific Domain, or a TermViolation will be generated.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBelongToDomain
    implements Contract<Term<?>, ValueMustNotBelongToDomain.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( ValueMustNotBelongToDomain.class );
    ...
    /**
     * <p>
     * Creates a new ValueMustNotBelongToDomain contract.
     * </p>
     *
     * @param domain The domain to which every inspected Term
     *               must belong.  Must not be null.
     */
    public ValueMustNotBelongToDomain (
                                       Domain<Term<?>> domain
                                       )
                           ...
                           )
    {
        ...
        final ValueMustNotBelongToDomain that =
            (ValueMustNotBelongToDomain) obj;
     ...
     */
    @Override
    public final ValueMustNotBelongToDomain.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustNotBelongToDomain.Violation ( this,
                                                          plaintiff,
                                                          evidence );
    }
    ...
    {
        final ValueMustNotBelongToDomain.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBelongToDomain contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBelongToDomain.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBelongToDomain.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          ValueMustNotBelongToDomain contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
