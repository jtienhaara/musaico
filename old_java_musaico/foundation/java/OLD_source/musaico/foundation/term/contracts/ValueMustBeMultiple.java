...
/**
 * <p>
 * A guarantee of a Term with Multiple values (such as Many values,
 * excluding only One value and possibly one or fewer Some values).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeMultiple
    implements Contract<Term<?>, ValueMustBeMultiple.Violation>, Serializable
{
    ...
    /** The ValueMustBeMultiple contract. */
    public static final ValueMustBeMultiple CONTRACT =
        new ValueMustBeMultiple ();
    ...
    {
        return "The term must be Multiple, containing no elements.";
    }
     ...
     */
    @Override
    public ValueMustBeMultiple.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustBeMultiple.Violation (
                       this,
                       plaintiff,
                       evidence );
    }
    ...
    {
        final ValueMustBeMultiple.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeMultiple contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeMultiple.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeMultiple.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Multiple.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
