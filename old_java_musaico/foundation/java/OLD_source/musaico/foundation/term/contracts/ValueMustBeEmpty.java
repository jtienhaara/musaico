...
/**
 * <p>
 * A guarantee of a term with an Empty value (including an Error or Timeout
 * and so on with No value).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeEmpty
    implements Contract<Term<?>, ValueMustBeEmpty.Violation>, Serializable
{
    ...
    /** The ValueMustBeEmpty contract. */
    public static final ValueMustBeEmpty CONTRACT =
        new ValueMustBeEmpty ();
    ...
    {
        return "The term must be Empty, containing no elements.";
    }
     ...
     */
    @Override
    public ValueMustBeEmpty.Violation violation (
                                                 Object plaintiff,
                                                 Term<?> evidence
                                                 )
    {
        return new ValueMustBeEmpty.Violation ( this,
                                                plaintiff,
                                                evidence );
    }
    ...
    {
        final ValueMustBeEmpty.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeEmpty contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeEmpty.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeEmpty.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Empty.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
