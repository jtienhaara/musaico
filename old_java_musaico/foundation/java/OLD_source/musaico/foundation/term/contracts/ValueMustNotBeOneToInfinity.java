 ...
 */
public class ValueMustNotBeOneToInfinity
    implements Contract<Term<?>, ValueMustNotBeOneToInfinity.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeOneToInfinity contract. */
    public static final ValueMustNotBeOneToInfinity CONTRACT =
        new ValueMustNotBeOneToInfinity ();
    ...
    {
        return "The term must not be OneToInfinity.";
    }
     ...
     */
    @Override
    public ValueMustNotBeOneToInfinity.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new ValueMustNotBeOneToInfinity.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final ValueMustNotBeOneToInfinity.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeOneToInfinity contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeOneToInfinity.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeOneToInfinity.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was OneToInfinity.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
