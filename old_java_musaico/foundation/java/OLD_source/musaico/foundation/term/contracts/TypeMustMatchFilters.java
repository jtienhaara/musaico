 ...
 * of each Type must be KEPT by specific Filter(s), or an UncheckedViolation
 * will be generated.
 * </p>
 *
 *
 ...
 */
public class TypeMustMatchFilters
    implements Contract<Type<?>, TypeMustMatchFilters.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustMatchFilters.class );


    // The Filter(s) which must match each element of every Type.
    private final Filter<Type<?>> [] filters;


    /**
     * <p>
     * Creates a new TypeMustMatchFilters contract.
     * </p>
     *
     * @param filters The Filter(s) which must match each element
     *                of every Type.  Must not be null.
     *                Must not contain any null elements.
     */
    @SuppressWarnings({"rawtypes", "unchecked"}) // Generic array creation.
    public TypeMustMatchFilters (
                                 Filter<Type<?>> ... filters
                                 )
    ...
    public final String description ()
    {
        ...
        return "Each type must be matched by all of the filter(s): { "
                                 ...
                                 )
    {
        ...
        final TypeMustMatchFilters that =
            (TypeMustMatchFilters) obj;
    ...
    /**
     * @return The Filter(s) which must match each whole Type.
     ...
     */
    @Override
    public final TypeMustMatchFilters.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustMatchFilters.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TypeMustMatchFilters.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustMatchFilters contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustMatchFilters.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustMatchFilters.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The filter(s) did not match the Type: "
                    + evidence
                    + ".", // description
                    plaintiff,
                    evidence,
