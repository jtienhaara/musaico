 ...
 * must be an instance of a specific class or interface,
 ...
 */
public class TypeMustBeInstanceOfClass
    implements Contract<Type<?>, TypeMustBeInstanceOfClass.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustBeInstanceOfClass.class );
    ...
    /**
     * <p>
     * Creates a new TypeMustBeInstanceOfClass contract.
     * </p>
     *
     * @param type_class The Class which each inspected Type must instantiate.
     *                   Must not be null.
     */
    public TypeMustBeInstanceOfClass (
            Class<?> type_class
            )
    ...
    /**
     * @return The InstanceOfClass domain to which each Type must belong.
     *         Never null.
     */
                                 ...
                                 )
    {
        ...
        final TypeMustBeInstanceOfClass that =
            (TypeMustBeInstanceOfClass) obj;
     ...
     */
    @Override
    public final TypeMustBeInstanceOfClass.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustBeInstanceOfClass.Violation (
                       this,
                       plaintiff,
                       evidence );
    }
    ...
    {
        final TypeMustBeInstanceOfClass.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustBeInstanceOfClass contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustBeInstanceOfClass.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustBeInstanceOfClass.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          TypeMustBeInstanceOfClass contract,
                          Object plaintiff,
                          Type<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
        ...
        {
            super ( contract,
                    "The type did not instantiate the class: "
                    + evidence
                    + ".", // description
                    plaintiff,
                    evidence,
