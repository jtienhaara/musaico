...
import musaico.foundation.term.multiplicities.Indefinite;


/**
 * <p>
 * A guarantee of any term that is NOT Indefinite (including
 * Finite, Infinite, Empty, and so on Terms).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeIndefinite
    implements Contract<Term<?>, ValueMustNotBeIndefinite.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeIndefinite contract. */
    public static final ValueMustNotBeIndefinite CONTRACT =
        new ValueMustNotBeIndefinite ();
    ...
    {
        return "The term must not be Indefinite.";
    }
            ...
            )
    {
        ...
        else if ( term instanceof Indefinite )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public ValueMustNotBeIndefinite.Violation violation (
                                                         Object plaintiff,
                                                         Term<?> evidence
                                                         )
    {
        return new ValueMustNotBeIndefinite.Violation ( this,
                                                        plaintiff,
                                                        evidence );
    }
    ...
    {
        final ValueMustNotBeIndefinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeIndefinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeIndefinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeIndefinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Indefinite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
