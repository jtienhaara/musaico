...
/**
 * <p>
 * Each inspected Term must be <code> equal ( ... ) </code> to a
 * specific Term, or a TermViolation will be generated.
 * </p>
 *
 ...
 */
public class ValueMustEqual
    implements Contract<Term<?>, ValueMustEqual.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( ValueMustEqual.class );


    // The EqualTo Domain to which every Term must belong.
    private final EqualTo domain;


    /**
     * <p>
     * Creates a new ValueMustEqual contract.
     * </p>
     *
     * @param term The Term whose value every inspected Term
     *             must equal.  Must not be null.
     */
    public ValueMustEqual (
                           Term<?> term
                           )
        throws ParametersMustNotBeNull.Violation
    {
        this ( new EqualTo ( term ) );
    }
     ...
     * </p>
     *
     * @param domain The EqualTo Domain to which every inspected Term
     ...
     */
    @Override
    public ValueMustEqual.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustEqual.Violation ( this,
                                              plaintiff,
                                              evidence );
    }
    ...
    {
        final ValueMustEqual.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustEqual contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustEqual.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustEqual.Violation.
         * </p>
         *
        ...
        private static final String nonMembers (
                                                EqualTo domain,
                                                Term<?> value
                                                )
        {
            ...
            for ( Object maybe_domain_object : value )
            {
                if ( ! domain.filter ( maybe_domain_object ).isKept () )
                {
                    if ( is_first )
                    {
                        is_first = false;
                    ...
                    sbuf.append ( "" + maybe_domain_object );
                }
            }
