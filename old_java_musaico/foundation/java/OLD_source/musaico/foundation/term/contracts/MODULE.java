...
/**
 * <p>
 * Module settings for the musaico.foundation.term.contracts module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "The most basic contracts used by and with Terms, such as TermMustBeCountable.CONTRACT and so on.  (Note that more specific contracts can be found in the other sub-modules, such as normal, finite, infinite, and so on contracts.)";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x5710450996CAC40F35BCE9B7177C7ED01FC7650F";
    ...
    static final long VERSION = 20170506L;
