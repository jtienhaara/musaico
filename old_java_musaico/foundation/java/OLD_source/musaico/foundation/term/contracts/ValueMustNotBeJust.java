...
/**
 * <p>
 * A guarantee of a Term that does not have Just one value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeJust
    implements Contract<Term<?>, ValueMustNotBeJust.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeJust contract. */
    public static final ValueMustNotBeJust CONTRACT =
        new ValueMustNotBeJust ();
    ...
    {
        return "The term must not have Just one element.";
    }
     ...
     */
    @Override
    public ValueMustNotBeJust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustNotBeJust.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    {
        final ValueMustNotBeJust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeJust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeJust.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeJust.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term has Just one element.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
