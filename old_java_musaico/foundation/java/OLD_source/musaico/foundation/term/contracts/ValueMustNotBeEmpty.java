...
/**
 * <p>
 * A guarantee of a Term with any value except an Empty one
 * (thus excluding Error terms, Timeout terms, and so on with No values).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeEmpty
    implements Contract<Term<?>, ValueMustNotBeEmpty.Violation>, Serializable
{
    ...
    public static final ValueMustNotBeEmpty CONTRACT =
        new ValueMustNotBeEmpty ();
    ...
    {
        return "The term must not be Empty.";
    }
     ...
     */
    @Override
    public ValueMustNotBeEmpty.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new ValueMustNotBeEmpty.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeEmpty contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeEmpty.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeEmpty.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Empty.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
