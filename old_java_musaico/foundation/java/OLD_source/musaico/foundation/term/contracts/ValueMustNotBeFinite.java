...
/**
 * <p>
 * A guarantee of any term except a finite-valued term (allowing
 * infinite multiple values).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeFinite
    implements Contract<Term<?>, ValueMustNotBeFinite.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeFinite contract. */
    public static final ValueMustNotBeFinite CONTRACT =
        new ValueMustNotBeFinite ();
    ...
    {
        return "The term must not be Finite.";
    }
            ...
            )
    {
        ...
        else if ( term instanceof Finite )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public ValueMustNotBeFinite.Violation violation (
                                                     Object plaintiff,
                                                     Term<?> evidence
                                                     )
    {
        return new ValueMustNotBeFinite.Violation ( this,
                                                    plaintiff,
                                                    evidence );
    }
    ...
    {
        final ValueMustNotBeFinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeFinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeFinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeFinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Finite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
