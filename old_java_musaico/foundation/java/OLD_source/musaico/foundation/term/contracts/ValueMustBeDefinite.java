...
/**
 * <p>
 * A guarantee of any term that is Definite (Definite values
 * are known quantities, such as Finite values, Infinite values,
 * and so on).
 * </p>
 *
 *
 ...
 */
public class ValueMustBeDefinite
    implements Contract<Term<?>, ValueMustBeDefinite.Violation>, Serializable
{
    ...
    /** The ValueMustBeDefinite contract. */
    public static final ValueMustBeDefinite CONTRACT =
        new ValueMustBeDefinite ();
    ...
    {
        return "The term must be Definite,"
            + " so that the number of elements"
            + "is always a known quantity, even if it is infinite.";
    }
            ...
            )
    {
        ...
        else if ( term instanceof Definite )
        {
     ...
     */
    @Override
    public ValueMustBeDefinite.Violation violation (
                                                    Object plaintiff,
                                                    Term<?> evidence
                                                    )
    {
        return new ValueMustBeDefinite.Violation ( this,
                                                   plaintiff,
                                                   evidence );
    }
    ...
    {
        final ValueMustBeDefinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeDefinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeDefinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeDefinite.Violation.
         * </p>
         *
         ...
         *                  Must not be null.
         *
         * @param evidence The Term whose value violated the contract.
         *                 Can be null.
         */
        public Violation (
                          Contract<?, ?> contract,
        ...
        {
            super ( contract,
                    "The term was not Definite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
