...
/**
 * <p>
 * A guarantee that every Type meets all Contracts in a specific set
 * of child Contracts.
 * </p>
 *
 *
 ...
 */
public class TypeMustMeetAllContracts
    implements Contract<Type<?>, TypeMustMeetAllContracts.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustMeetAllContracts.class );
    ...
    /**
     * <p>
     * Creates a new TypeMustMeetAllContracts.
     * </p>
     *
     * @param child_contracts The child contracts which comprise this
     *                        TypeMustMeetAllContracts composite contract.
    ...
    public TypeMustMeetAllContracts (
    ...
    public final String description ()
    {
        ...
        return "The type must meet all Contracts: "
            + sbuf.toString ();
    }
            ...
            )
    {
        ...
        final TypeMustMeetAllContracts that = (TypeMustMeetAllContracts) obj;
        for ( int c = 0;
     ...
     */
    @Override
    public TypeMustMeetAllContracts.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustMeetAllContracts.Violation ( this,
                                                         plaintiff,
                                                         evidence );
    }
    ...
    {
        final TypeMustMeetAllContracts.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustMeetAllContracts contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustMeetAllContracts.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustMeetAllContracts.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The type did not meet all of the Contracts.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
