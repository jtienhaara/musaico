...
/**
 * <p>
 * A general-purpose Contract for Terms: each Term must be DISCARDED
 ...
 */
public class TermMustNotMatchFilters
    implements Contract<Term<?>, TermMustNotMatchFilters.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TermMustNotMatchFilters.class );
    ...
    /**
     * <p>
     * Creates a new TermMustNotMatchFilters contract.
     * </p>
     *
    ...
    public TermMustNotMatchFilters (
                                     Filter<Term<?>> ... filters
                                     )
    ...
    public final String description ()
    {
        ...
        return "Each term must NOT be matched by any of the filter(s) { "
                                 ...
                                 )
    {
        ...
        final TermMustNotMatchFilters that =
            (TermMustNotMatchFilters) obj;
    ...
    /**
     * @return The Filter(s) which must NOT match each whole Term.
     ...
     */
    @Override
    public final TermMustNotMatchFilters.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotMatchFilters.Violation ( this,
                                                        plaintiff,
                                                        evidence );
    }
    ...
    {
        final TermMustNotMatchFilters.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotMatchFilters contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotMatchFilters.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotMatchFilters.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          TermMustNotMatchFilters contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
