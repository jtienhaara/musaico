...
/**
 * <p>
 * A guarantee of a Term with Just one value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeJust
    implements Contract<Term<?>, ValueMustBeJust.Violation>, Serializable
{
    ...
    /** The ValueMustBeJust contract. */
    public static final ValueMustBeJust CONTRACT =
        new ValueMustBeJust ();
    ...
    {
        return "The term must have Just one element.";
    }
     ...
     */
    @Override
    public ValueMustBeJust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustBeJust.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    {
        final ValueMustBeJust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeJust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeJust.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeJust.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term did not have Just one element.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
