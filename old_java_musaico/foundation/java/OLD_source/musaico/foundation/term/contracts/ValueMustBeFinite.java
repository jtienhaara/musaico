...
/**
 * <p>
 * A guarantee of a term with a Finite value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeFinite
    implements Contract<Term<?>, ValueMustBeFinite.Violation>, Serializable
{
    ...
    /** The ValueMustBeFinite contract. */
    public static final ValueMustBeFinite CONTRACT =
        new ValueMustBeFinite ();
    ...
    {
        return "The term must be Finite, containing a finite number"
            + "of elements.";
    }
     ...
     */
    @Override
    public ValueMustBeFinite.Violation violation (
                                                  Object plaintiff,
                                                  Term<?> evidence
                                                  )
    {
        return new ValueMustBeFinite.Violation ( this,
                                                 plaintiff,
                                                 evidence );
    }
    ...
    {
        final ValueMustBeFinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeFinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeFinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeFinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Finite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
