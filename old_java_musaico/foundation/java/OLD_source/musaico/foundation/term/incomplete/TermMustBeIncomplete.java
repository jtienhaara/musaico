...
/**
 * <p>
 * A guarantee of an incomplete term
 * (Blocking or Partial or an Expression applying an operation
 * to some input; or a failed result due to Timeout or being Cancelled;
 * and so on).
 * </p>
 *
 *
 ...
 */
public class TermMustBeIncomplete
    implements Contract<Term<?>, TermMustBeIncomplete.Violation>, Serializable
{
    ...
    /** The TermMustBeIncomplete contract. */
    public static final TermMustBeIncomplete CONTRACT =
        new TermMustBeIncomplete ();
    ...
    {
        return "The term must be Incomplete, a term which is"
            + " a snapshot in time, and might eventually evolve"
            + " into a complete term.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Incomplete )
        {
     ...
     */
    @Override
    public TermMustBeIncomplete.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new TermMustBeIncomplete.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustBeIncomplete.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeIncomplete contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeIncomplete.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeIncomplete.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Incomplete.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
