 ...
 * but are not in the other stream.
 * </p>
 *
 * <p>
 ...
 */
public class Except<VALUE extends Object>
    ...
    implements Serializable
{
    ...
    /**
     * <p>
     * Creates a new stateless Except template.
     * </p>
     *
     ...
     */
    protected final Except<VALUE> instantiate ()
    ...
    protected final TermViolation different (
            TermBuilder<VALUE> difference_builder,
            VALUE element
            )
        throws ParametersMustNotBeNull.Violation
    {
        // Add the element to the difference builder.
        difference_builder.add ( element );
               ...
               Parameter4.MustBeGreaterThanOrEqualToZero.Violation
    {
        ...
        final TermBuilder<VALUE> difference_builder =
        ...
        for ( Term<VALUE> left_term : left )
        {
            ...
            final boolean is_continuing =
                this.add (
                    ...
                    right,              // other_terms
                    difference_builder, // set_builder
                    downstream );       // downstream
