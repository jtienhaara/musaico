...
/**
 * <p>
 * A Transform specified by an input Term Tap and an Operation;
 * when requested, the Term Tap is resolved to its output,
 * and the resulting Term is passed through the Operation to
    ...
    implements Transform<FROM, TO>, Serializable
{
    ...
    private final TermPipeline.TermTap<FROM> input;
    ...
    public TermTransform (
            TermPipeline.TermTap<FROM> input,
    ...
    {
        final Term<TO> term = this.output ();
     ...
     */
    @Override
    public final TermPipeline.TermTap<TO> check ()
        ...
        throws ParametersMustNotBeNull.Violation
    {
             ...
             || ( that instanceof TermPipeline ) )
        {
            ...
            final boolean is_contained_by_input =
                this_input_source.contains ( that );
     ...
     */
    @Override
    public final Edit<TO, TermPipeline.TermTap<TO>, Term<TO>> edit ()
        throws ReturnNeverNull.Violation
    {
        return new ToplevelTermPipeline<TO> ( this )
            .edit ();
     ...
     */
    @Override
    public final TermFork<TO, TermPipeline.TermTap<TO>> fork ()
        throws ReturnNeverNull.Violation
    {
        // Throws ParametersMustNotBeNull.Violation:
        return new ToplevelTermPipeline<TO> ( this )
     ...
     */
    @Override
    public final TermGroup<TO, TermPipeline.TermTap<TO>> group ()
        throws ReturnNeverNull.Violation
    {
        // Throws ParametersMustNotBeNull.Violation:
        return new ToplevelTermPipeline<TO> ( this )
     ...
     */
    @Override
    public final TermPipeline.TermTap<FROM> inputOrigin ()
        throws ReturnNeverNull.Violation
    {
        return this.input;
    }
     ...
     */
    @Override
    public final TermPipeline.TermTap<FROM> inputSource ()
        throws ReturnNeverNull.Violation
    {
        return this.input;
    }
    ...
    /**
     * @see musaico.foundation.term.TermPipeline.TermTap#operations()
     */
    @Override
    public final OperationPipeline.OperationTap<TO> operations ()
        throws ReturnNeverNull.Violation
    {
    ...
    public final OrderBy<TO, TermPipeline.TermTap<TO>> orderBy (
            Order<TO> ... orders
            )
        throws ParametersMustNotBeNull.Violation,
               Parameter1.MustContainNoNulls.Violation,
     ...
     */
    @Override
    public final TermPipeline.TermTap<TO> pipe (
    ...
    @Override
    public final TermPipeline.TermTap<TO> pipe (
            OperationPipeline.OperationTap<TO> pipeline
            )
        throws ParametersMustNotBeNull.Violation,
               ReturnNeverNull.Violation
    {
     ...
     */
    @Override
    public final Select<TO, TermPipeline.TermTap<TO>> select ()
        throws ReturnNeverNull.Violation
    {
        return new ToplevelTermPipeline<TO> ( this )
            .select ();
     ...
     */
    @Override
    @SuppressWarnings("unchecked") // Cast this - TermPipeline.TermTap<OUTPUT>
     ...
     */
    @Override
    public final TermWhen<TO, TermPipeline.TermTap<TO>> when (
            Filter<?> condition
            )
        throws ParametersMustNotBeNull.Violation,
               ReturnNeverNull.Violation
    ...
    @Override
    @SuppressWarnings("unchecked") // Generic array heap pollution.
    public final Where<TO, TermPipeline.TermTap<TO>> where (
            Filter<TO> ... filters
            )
        throws ParametersMustNotBeNull.Violation,
               Parameter1.MustContainNoNulls.Violation,
