...
/**
 * <p>
 * Module settings for the musaico.foundation.domains.elements module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Various implementations of the sequence of Elements representing an array, Collection, Iterable, single object, and so on, for ArrayDomains.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xA724A9EBCD94B3B7A7D3E09EC6DAC7C2FA062C8A";
    ...
    static final long VERSION = 20180410L;
