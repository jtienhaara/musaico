...
/**
 * <p>
 * The domain of all Strings which do not include any space characters
    ...
    implements Serializable
{
    ...
    /** The StringExcludesSpaces domain singleton. */
    public static final StringExcludesSpaces DOMAIN =
        new StringExcludesSpaces ();


    protected StringExcludesSpaces ()
    {
        super ( "^[^\\s]*$" );
    }
