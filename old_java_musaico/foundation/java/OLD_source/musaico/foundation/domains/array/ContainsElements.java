...
/**
 * <p>
 * The domain of all single objects, arrays and iterables which
 * contain a specific subset of elements.
 * </p>
 *
 *
 * <p>
 ...
 * across RMI.  However the user of a ContainsElements domain
 * must be careful because the elements in the domain do not
 * have to be Serializable.  Attempting to serialize a ContainsElements
    ...
    implements ArrayDomain, Serializable
{
    ...
    /**
     * <p>
     * Creates a new domain of arrays/collections containing the specified
     * elements.
     * </p>
     *
     * @param elements The elements which form a subset of every
        ...
        throws NullPointerException
    {
        if ( elements == null )
        {
            throw new NullPointerException ( "Cannot create a ContainsElements ( " + elements + " )" );
        }
    ...
    /**
     * @return The bitset indicating which required elements are
     *         contained in the specified array (true), and which
     *         ones are missing (false).  The Nth bit corresponds
     *         to the Nth required element.  Never null.
     */
            ...
            )
    {
        ...
        // When we find all of the required elements in the array,
                           ...
                           )
    {
        ...
        final ContainsElements that = (ContainsElements) obj;
    ...
    /**
     * @return The required elements which are missing from each
     *         non-member array.
     *
            ...
            )
    {
        ...
        final List<Object> missing_elements =
            new ArrayList<Object> ();
        for ( int e = 0; e < this.elements.length; e ++ )
        {
            if ( ! found_flags.get ( e ) )
            {
                missing_elements.add ( this.elements [ e ] );
            }
        }

        if ( missing_elements.size () > 0 )
        {
            // Only add an array of the missing elements to the result.
            non_members.add (
