...
/**
 * <p>
 * The domain of all elements which are not in a specific array, Collection
 * or Iterable.
 * </p>
 *
 *
 ...
 * across RMI.  However the user of a NotElementOf domain
 * must be careful because the elements in the domain do not
 * have to be Serializable.  Attempting to serialize a NotElementOf
    ...
    implements Domain<Object>, Serializable
{
    ...
    // The Elements of which every object in this domain is NOT a member.
    private final Elements<Object> array;


    /**
     * <p>
     * Creates a new domain of non-elements of the specified array.
     * </p>
     *
     ...
     *              in this domain is NOT an element.  Must not be null.
     *              Must not contain any null elements.
     */
    @SafeVarargs
    @SuppressWarnings("varargs") // ELEMENT ...
    public <ELEMENT extends Object> NotElementOf (
            Class<ELEMENT> element_class,
            ELEMENT ... array
            )
        throws NullPointerException
    {
        this ( new ArrayElements<ELEMENT> ( element_class,
                                            array ) );
    }
    ...
    /**
     * <p>
     * Creates a new domain of non-elements of the specified Collection.
     * </p>
     *
     * @param element_class The class of elements in this domain.
     *                      Must not be null.
    ...
    /**
     * <p>
     * Creates a new domain of non-elements of the specified Iterable.
     * </p>
     *
     * @param element_class The class of elements in this domain.
     *                      Must not be null.
    ...
    /**
     * <p>
     * Creates a new domain of non-elements of the specified Elements.
     * </p>
     *
     * @param array The specific array or Collection or Iterable
     *              of which every object in this domain is NOT an element.
        ...
        throws NullPointerException
    {
        if ( array == null )
        {
            throw new NullPointerException ( "Cannot create a NotElementOf ( " + array + " )" );
        }
    ...
    /**
     * @return The specific array whose elements are not in this domain.
            ...
            )
    {
        ...
        final NotElementOf that = (NotElementOf) obj;
        if ( this.array == null )
        {
            if ( that.array != null )
            {
