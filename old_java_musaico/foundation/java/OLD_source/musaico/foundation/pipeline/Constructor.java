 ...
 */
public interface Constructor<PARAMETER extends Object, CONSTRUCT extends Construct<GOAL>, GOAL extends Construct<GOAL>>
    extends Construct<GOAL>, Serializable
{
     ...
     *                  any null elements.
     *
     * @return Either the next stage of Constructors or branching Choos steps,
