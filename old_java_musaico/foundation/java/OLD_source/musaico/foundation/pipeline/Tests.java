...
public class Tests
{
    ...
    public <PIPELINE extends Sink<Thread, PIPELINE, Thread, PIPELINE, Source<PIPELINE, Thread, PIPELINE>>, CONSTRUCTOR extends Constructor<String, Constructor<Number, Constructor<int[], PIPELINE, PIPELINE>, PIPELINE>, PIPELINE>>
        void test (
            CONSTRUCTOR constructor,
            Choose<Construct<PIPELINE>, PIPELINE> chooser,
            Choice<Construct<PIPELINE>, PIPELINE, PIPELINE> pipeline_choice,
            Choice<Construct<PIPELINE>, CONSTRUCTOR, PIPELINE> constructor_choice
            )
    {
