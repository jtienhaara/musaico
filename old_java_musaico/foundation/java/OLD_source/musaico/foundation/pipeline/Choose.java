 ...
 */
public interface Choose<CONSTRUCTS extends Construct<GOAL>, GOAL extends CONSTRUCTS>
    extends Construct<GOAL>, Serializable
{
     ...
     *
     * @return Either the next stage of Constructors or Choos branches,
     *         or the final, constructed Pipeline.  Never null.
     */
    public abstract <CHOSEN_CONSTRUCT extends CONSTRUCTS, CHOICE extends Choice<CONSTRUCTS, CHOSEN_CONSTRUCT, GOAL>>
