 ...
 *
 * <p>
 * For example, an Includes that includes numbers matched by the
 * <code> GreaterThanOrEqualToZero.FILTER </code> will keep a container
 * with at least one 0 element, but discard any container that has
 ...
 */
public class Includes<ELEMENT extends Object>
    ...
    implements Serializable
{
    ...
    {
        this ( Includes.oneQualifier ( qualifiers ) );
    }
