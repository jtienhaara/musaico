...
import musaico.foundation.filter.container.AndContainers;


/**
 * <p>
 * Logically ANDs together the filter results of one or
 * more child ElementsFilters, so that a given object will be KEPT only if
 ...
 */
public class AndElements<ELEMENT extends Object>
    extends AndContainers<ELEMENT>
