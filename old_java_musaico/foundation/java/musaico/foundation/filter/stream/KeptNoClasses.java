...
/**
 * <p>
 * Discards each container if it contains any instance(s) of any
 * class(es) in a specific set.
 * </p>
 *
 * <p>
 ...
 */
public class KeptNoClasses<ELEMENT extends Object>
    implements FilterStream<ELEMENT>, Serializable
{
            ...
            )
    {
        ...
        final KeptNoClasses<?> that = (KeptNoClasses<?>) object;
            ...
            synchronized ( this.lock )
            {
                for ( Class<?> instance_class : this.keptClasses.keySet () )
                {
                    if ( instance_class.isInstance ( element ) )
                    {
                        ...
                        // Short-circuit: we've found an instance of a class.
                        return FilterState.DISCARDED;
                    }
                }
            }
