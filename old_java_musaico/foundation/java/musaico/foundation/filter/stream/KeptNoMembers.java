...
/**
 * <p>
 * Discards each container if it contains any member(s) of
 ...
 */
public class KeptNoMembers<MEMBER extends Object>
    implements FilterStream<MEMBER>, Serializable
{
            ...
            )
    {
        ...
        final KeptNoMembers<?> that = (KeptNoMembers<?>) object;
        ...
        throws NullPointerException
    {
        ...
        else if ( element_filter_state.isKept () )
        {
            ...
            // Short-circuit: we've found a member.
            return FilterState.DISCARDED;
        }
