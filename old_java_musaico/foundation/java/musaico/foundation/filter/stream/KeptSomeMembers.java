...
/**
 * <p>
 * Discards each container unless it contains at least one member of
 ...
 */
public class KeptSomeMembers<MEMBER extends Object>
    implements FilterStream<MEMBER>, Serializable
{
            ...
            )
    {
        ...
        final KeptSomeMembers<?> that = (KeptSomeMembers<?>) object;
        ...
        throws NullPointerException
    {
        ...
        else if ( element_filter_state.isKept () )
        {
            ...
            // Short-circuit: we've found at least one member.
