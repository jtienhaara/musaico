...
/**
 * <p>
 * Discards each container unless it contains at least one instance of
 * a specific set of classes.
 * </p>
 *
 * <p>
 * An empty container is discarded.
 * </p>
 *
 *
 * <p>
 ...
 */
public class KeptSomeClasses<ELEMENT extends Object>
    implements FilterStream<ELEMENT>, Serializable
{
            ...
            )
    {
        ...
        final KeptSomeClasses<?> that = (KeptSomeClasses<?>) object;
            ...
            synchronized ( this.lock )
            {
                for ( Class<?> instance_class : this.keptClasses.keySet () )
                {
                    if ( instance_class.isInstance ( element ) )
                    {
                        ...
                        // Short-circuit: we've found at least one instance
