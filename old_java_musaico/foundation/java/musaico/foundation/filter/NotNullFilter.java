...
/**
 * <p>
 * Discards (filters out) all null inputs, keeps (matches)
 * everything else.
 * </p>
 *
 *
 ...
 */
public class NotNullFilter<GRAIN extends Object>
    implements Filter<GRAIN>, Serializable
{
    ...
    /** Singleton NotNullFilter covering Objects, for when
     *  generics are unnecessary. */
    public static final NotNullFilter<Object> FILTER =
        new NotNullFilter<Object> ();
