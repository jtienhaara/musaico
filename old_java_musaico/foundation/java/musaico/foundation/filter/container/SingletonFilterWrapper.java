 ...
 * hierarchies of Filters that deal with singletons
 * (single objects, not to be confused with the Design Pattern).
 * </p>
 *
 * <p>
 ...
 * for example, a new <code> SingletonFilterWrapper&lt;String&gt; </code>
 ...
 */
public class SingletonFilterWrapper<ELEMENT extends Object>
    implements Filter<ELEMENT>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new SingletonFilterWrapper to wrap the specified
            ...
            )
    {
        ...
        final SingletonFilterWrapper<?> that =
            (SingletonFilterWrapper<?>) object;
            ...
            )
    {
        final FilterState filter_state =
            this.containerFilter.filterSingleton ( container );
        return filter_state;
    }
