...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.container module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Filters which apply to arrays, Collections, Iterable values, singletons, and other containers.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xEAB7B2E4D2B874D1F6D1173713687D8C317ABC35";
    ...
    static final long VERSION = 20201023L;
