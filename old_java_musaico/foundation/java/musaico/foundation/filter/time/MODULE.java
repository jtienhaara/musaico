...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.time module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Time-based Filters, such as Filters matching immutable values which are Unchanging over time, as well as tools to track and measure time.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x107749FA4C5DF513D8DD15F2E05EEE0DCC94BC3A";
    ...
    static final long VERSION = 20190118L;
