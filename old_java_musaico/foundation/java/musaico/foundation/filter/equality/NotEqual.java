...
/**
 * <p>
 * Keeps all pairs of objects which are not equal to each other.
 * </p>
 *
 *
 * <p>
 ...
 */
public class NotEqual<SIDE extends Object>
    implements Filter<LeftAndRight<SIDE, SIDE>>, Serializable
{
    ...
    /** Singleton NotEqual filter covering plain Objects,
     *  for when generics are unnecessary. */
    public static final NotEqual<Object> FILTER =
        new NotEqual<Object> ();
    ...
    /**
     * @see musaico.foundation.filter.NotEqual#filter(musaico.foundation.filter.comparability.LeftAndRight))
     */
    public final FilterState filter (
            SIDE left,
            SIDE right
