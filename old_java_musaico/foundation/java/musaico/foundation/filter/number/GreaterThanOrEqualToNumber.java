...
/**
 * <p>
 * Keeps all numbers which are greater than or equal to
 * a specific number.
 * </p>
 *
 *
 ...
 */
public class GreaterThanOrEqualToNumber<NUMBER extends Number>
    implements Filter<NUMBER>, Serializable
{
    ...
    // The Number than which each number must be greater than or equal to
    // in order to be kept by this filter.
    private final NUMBER number;


    /**
     * <p>
     * Creates a new GreaterThanOrEqualToNumber filter.
     * </p>
     *
     * @param number The number than which each number must be
     *               greater or equal to in order to be kept (according to
