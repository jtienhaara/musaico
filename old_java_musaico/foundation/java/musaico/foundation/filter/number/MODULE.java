...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.number module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Filters that apply to Numbers, such as greater than / less than filters.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xA279C6DE0FA93FAAF8A82C3F6EBA7C88DCDD5FAA";
    ...
    static final long VERSION = 20190117L;
