...
/**
 * <p>
 * Keeps all numbers which are less than or equal to
 * a specific number.
 * </p>
 *
 *
 ...
 */
public class LessThanOrEqualToNumber<NUMBER extends Number>
    implements Filter<NUMBER>, Serializable
{
    ...
    // The Number than which each number must be less than or equal to
    ...
    /**
     * <p>
     * Creates a new LessThanOrEqualToNumber filter.
     * </p>
     *
     * @param number The number than which each number must be less
     *               or equal to in order to be kept (according to
