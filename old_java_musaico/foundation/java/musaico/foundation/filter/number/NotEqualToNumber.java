...
/**
 * <p>
 * Keeps all Numbers which are not equal to a specific Number.
 * </p>
 *
 *
 * <p>
 ...
 */
public class NotEqualToNumber<NUMBER extends Number>
    implements Filter<NUMBER>, Serializable
{
    ...
    // The Number to be discarded, while all others are kept.
    private final NUMBER number;


    /**
     * <p>
     * Creates a new NotEqualToNumber the specified Number,
     * matching all possible Numbers except the specified one.
     * </p>
     *
     * @param number The number to which each number must not be equal
