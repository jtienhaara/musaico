...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.composite module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String COPYRIGHT =
        "Copyright (c) 2010-2018 Johann Tienhaara <jtienhaara@yahoo.com>";

    /** Human-readable description of the purpose of this module. */
    private static final String DESCRIPTION =
        "Commonly used composite filters, including logical filters such as AND, OR, NOT, XOR.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x4D8E58040546429C7FE1EB27B63402E012674C32";
    ...
    static final long VERSION = 20201019L;
