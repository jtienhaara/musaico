...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.string module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Filters for Strings, checking length, patterns, and so on.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x381B0379EF6D55CFB18CFA567DBC5F437201FF83";
