...
/**
 * <p>
 * Module settings for the musaico.foundation.filter.comparability module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Filters for (in-)comparable objects, and the Comparators"
        + " that determine which pairs of objects match the filters.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x2AF720E602388DEA8D0D3D5CCFA4A45F96592D2B";
    ...
    static final long VERSION = 20190115L;
