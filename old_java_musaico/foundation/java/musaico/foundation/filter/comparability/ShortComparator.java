 ...
 */
public class ShortComparator<NUMBER extends Number>
    implements Comparator<NUMBER>, Serializable
{
    ...
    /** The singleton generic ShortComparator, for comparing
     *  Shorts to other Numbers. */
    public static final ShortComparator<Number> COMPARATOR =
        new ShortComparator<Number> ();

    /** The singleton specific ShortComparator, for comparing
     *  Shorts to Shorts. */
    public static final ShortComparator<Short> SHORT_COMPARATOR =
        new ShortComparator<Short> ();


    // Creates the ShortComparator singletons.
    // Use ShortComparator.COMPARATOR
    // or ShortComparator.SHORT_COMPARATOR instead.
