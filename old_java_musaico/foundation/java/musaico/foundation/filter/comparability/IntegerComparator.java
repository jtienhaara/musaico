 ...
 */
public class IntegerComparator<NUMBER extends Number>
    implements Comparator<NUMBER>, Serializable
{
    ...
    /** The singleton generic IntegerComparator, for comparing
     *  Integers to other Numbers. */
    public static final IntegerComparator<Number> COMPARATOR =
        new IntegerComparator<Number> ();

    /** The singleton specific IntegerComparator, for comparing
     *  Integers to Integers. */
    public static final IntegerComparator<Integer> INTEGER_COMPARATOR =
        new IntegerComparator<Integer> ();


    // Creates the IntegerComparator singletons.
    // Use IntegerComparator.COMPARATOR
    // or IntegerComparator.INTEGER_COMPARATOR instead.
