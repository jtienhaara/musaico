    ...
    implements Serializable
{
            ...
            )
    {
        ...
        {
            final Class<?> classifier = (Class<?>) object;
            return ClassName.of ( classifier );
        }
    ...
    {
        return StringRepresentation.of (
                   elements,                                     // elements
                   max_total_length,                             // max_total_length
                   StringRepresentation.DEFAULT_OBJECT_LENGTH ); // max_element_length
    }
     ...
     *                         Can be 0 or less for no maximum.
     *
     * @param max_element_length The maximum String length of any single
     *                           element, beyond which "..." will
     *                           replace part or all of the element's
     *                           representation.  Can be 0 or less
     *                           for no maximum.
     *
     * @return The String representation of the specified elements.
     *         Never null.
                       ...
                       )
    {
        ...
        for ( ELEMENT element : elements ) // Don't bother preventing infinity.
        {
            ...
            if ( max_remaining_length > max_element_length )
            {
