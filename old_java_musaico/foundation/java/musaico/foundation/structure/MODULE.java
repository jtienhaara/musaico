...
/**
 * <p>
 * Module settings for the musaico.foundation.structure module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Simple data structures and procedures for creating string representations, comparing numbers, calculating time differentials, and so on.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x07CE1428143DE8CB0C0D5C5CE81B5A8C08E16616";
    ...
    static final long VERSION = 20201012L;
