...
/**
 * <p>
 * Module settings for the musaico.foundation.wiring module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String COPYRIGHT =
        "Copyright (c) 2020-2020 Johann Tienhaara <jtienhaara@yahoo.com>";

    /** Human-readable description of the purpose of this module. */
    private static final String DESCRIPTION =
        "A simplified graph structure, inspired loosely by electronics, that supports the basic principles behind a few different models of programming and program execution (imperative, functional, rule-based, flow-based programming).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xC09C5233F95831B5DFEA7550F76605EC6E642572";
    ...
    static final long VERSION = 20201014L;
