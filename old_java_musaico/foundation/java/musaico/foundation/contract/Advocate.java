 ...
 * method of the Advocate is invoked to enforce
 ...
 *             new Advocate ( House.class );
 *         private final Advocate advocate;
 *
 *         public House ( ... )
 *             throws ...
 *         {
 *             classAdvocate.check ( ... ); // Constructor contracts are generally checked at the first line of the constructor.
 *             ...
 *             this.advocate = new Advocate ( this ); // Generally the last line of the constructor.
 *         }
 *
 *         public Room getRoom (
 *                 String name
 ...
 *         {
 *             this.advocate.check ( ParametersMustNotBeNull.CONTRACT ); // Throws ParametersMustNotBeNull.Violation
 *             ...
 *         }
 *
 *         ...
    ...
    implements Serializable
{
     ...
     *                  Must not be null.
     *
     * @param judge The Judge who checks and enforces contracts
     *              for our plaintiff.  Must not be null.
     */
    public Advocate (
            Object plaintiff,
            Judge judge
