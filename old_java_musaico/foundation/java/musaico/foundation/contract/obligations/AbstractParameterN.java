 ...
 * of a specific AbstractParameterN contract.  For example an interface
 ...
 */
public abstract class AbstractParameterN
    implements Serializable
{
    ...
    // String representation of this AbstractParameterN, such as
    ...
    /**
     * <p>
     * Creates a new AbstractParameterN.
     * </p>
     */
    protected AbstractParameterN ()
    {
    ...
    /*
     * @return This AbstractParameterN into a human-readable string.
    ...
    protected String parameterAsString ()
    {
        ...
        else if ( parameter_bitmap == AbstractParameterN.EVERY_PARAMETER )
        {
     ...
     *         Can be AbstractParameterN.EVERY_PARAMETER to represent
     ...
     *         parameters, or ( AbstractParameterN.EVERY_PARAMETER - 0x0002 )
    ...
    // unravel the stack because AbstractParameterN filtering is fundamental
        ...
        implements Contract<EVIDENCE, VIOLATION>, Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        private final AbstractParameterN parameter;
        ...
        public AbstractObligation (
            AbstractParameterN parameter
            )
            throws NullPointerException
        {
            if ( parameter == null )
            {
                throw new NullPointerException ( "AbstractParameterN.AbstractObligation must not be created with a null AbstractParameterN: "
                    + parameter );
            }
         ...
         *         Never null.
         */
        public final AbstractParameterN parameter ()
        {
     ...
     * AbstractParameterN.MustBeInDomain,
     * check parameter1 against a new
     * AbstractParameterN.MustBeInDomain ( Has4Wheels.CONTRACT ) at runtime,
     ...
     * AbstractParameterN.AlwaysInDomain.Violation reveals more to the caller
     * about what the nature of the domain, and provides an assertion
     * filter for unit testing.
     * </p>
     *
     * @see musaico.foundation.filter
     * @see musaico.foundation.contract.obligations.AbstractParameterN
     */
    public static abstract class MustBeInDomain<DOMAIN extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeInDomain<DOMAIN, VIOLATION>, DOMAIN, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        // Every AbstractParameterN.AbstractObligation must implement
        // musaico.foundation.contract.obligations.AbstractParameterN.AbstractObligation#violation(java.lang.Object, java.lang.Object, java.lang.String)

        /**
         * @see musaico.foundation.contract.obligations.AbstractParameterN.AbstractObligation#violationMessage(java.lang.Object, java.lang.Object, java.lang.Throwable)
         */
        @Override
    ...
    public static abstract class MustNotBeNull<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotBeNull<VIOLATION>, Object, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return NotNullFilter.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustChange<CHANGED extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustChange<CHANGED, VIOLATION>, BeforeAndAfter<CHANGED>, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        @Override
        public FilterState filter (
                BeforeAndAfter<CHANGED> grain
                )
        {
            return this.changing.filter ( grain );
        }
    ...
    public static abstract class MustNotChange<UNCHANGED extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotChange<UNCHANGED, VIOLATION>, BeforeAndAfter<UNCHANGED>, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        @Override
        public FilterState filter (
                BeforeAndAfter<UNCHANGED> grain
                )
        {
            return this.unchanging.filter ( grain );
        }
    ...
    public static abstract class MustEqual<EQUAL extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustEqual<EQUAL, VIOLATION>, EQUAL, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustNotEqual<UNEQUAL extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotEqual<UNEQUAL, VIOLATION>, UNEQUAL, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeGreaterThanNegativeOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanNegativeOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanNegativeOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThanOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThanZero<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanZero<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanZero.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThanOrEqualToNegativeOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanOrEqualToNegativeOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanOrEqualToNegativeOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThanOrEqualToOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanOrEqualToOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanOrEqualToOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThanOrEqualToZero<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanOrEqualToZero<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return GreaterThanOrEqualToZero.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanNegativeOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanNegativeOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanNegativeOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanZero<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanZero<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanZero.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanOrEqualToNegativeOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanOrEqualToNegativeOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanOrEqualToNegativeOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanOrEqualToOne<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanOrEqualToOne<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanOrEqualToOne.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeLessThanOrEqualToZero<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanOrEqualToZero<VIOLATION>, Number, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return LessThanOrEqualToZero.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeGreaterThan<NUMBER extends Number, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThan<NUMBER, VIOLATION>, NUMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeGreaterThanOrEqualTo<NUMBER extends Number, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeGreaterThanOrEqualTo<NUMBER, VIOLATION>, NUMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeLessThan<NUMBER extends Number, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThan<NUMBER, VIOLATION>, NUMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeLessThanOrEqualTo<NUMBER extends Number, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeLessThanOrEqualTo<NUMBER, VIOLATION>, NUMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeBetween<NUMBER extends Number, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeBetween<NUMBER, VIOLATION>, NUMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeInBounds<BOUNDED extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeInBounds<BOUNDED, VIOLATION>, BOUNDED, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeInstanceOf<INSTANCE extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeInstanceOf<INSTANCE, VIOLATION>, INSTANCE, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustNotBeInstanceOf<INSTANCE extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotBeInstanceOf<INSTANCE, VIOLATION>, INSTANCE, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeEmptyString<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeEmptyString<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return EmptyString.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustNotBeEmptyString<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotBeEmptyString<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return NotEmptyString.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeStringLength<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeStringLength<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustExcludeSpaces<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustExcludeSpaces<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringExcludesSpaces.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustContainNonSpaces<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainNonSpaces<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringContainsNonSpaces.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustContainOnlyNumerics<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyNumerics<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringContainsOnlyNumerics.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustContainOnlyAlpha<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyAlpha<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringContainsOnlyAlpha.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustContainOnlyAlphaNumerics<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyAlphaNumerics<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringContainsOnlyAlphaNumerics.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustContainOnlyPrintableCharacters<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyPrintableCharacters<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringContainsOnlyPrintableCharacters.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustBeStringID<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeStringID<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return StringID.FILTER.filter ( grain );
        }
    ...
    public static abstract class MustMatchPattern<VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustMatchPattern<VIOLATION>, String, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustBeMemberOf<MEMBER extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustBeMemberOf<MEMBER, VIOLATION>, Object, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustNotBeMemberOf<MEMBER extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustNotBeMemberOf<MEMBER, VIOLATION>, MEMBER, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainMembers<MEMBER extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainMembers<MEMBER, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainOnlyMembers<MEMBER extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyMembers<MEMBER, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustExcludeMembers<MEMBER extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustExcludeMembers<MEMBER, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainIndices<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainIndices<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
        ...
        {
            return this.indicesFilter.filter ( array_or_collection );
        }
    ...
    public static abstract class MustContainOnlyIndices<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyIndices<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustExcludeIndices<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustExcludeIndices<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainNoDuplicates<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainNoDuplicates<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static class Length
    {
         ...
         */
        public static abstract class MustBeGreaterThanOne<VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeGreaterThanOne<VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
            ...
            {
                return LengthFilter.GREATER_THAN_ONE.filter ( grain );
            }
            ...
            {
                return "" + this.parameter () + " contains "
                    + AbstractParameterN.Length.of ( evidence_or_null )
                    + " elements";
            }
        }
         ...
         */
        public static abstract class MustBeGreaterThanZero<VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeGreaterThanZero<VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
            ...
            {
                return LengthFilter.GREATER_THAN_ZERO.filter ( grain );
            }
        ...
        public static abstract class MustEqual<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustEqual<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustNotEqual<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustNotEqual<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustEqualZero<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustEqualZero<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustEqualOne<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustEqualOne<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustBeGreaterThan<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeGreaterThan<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustBeGreaterThanOrEqualTo<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeGreaterThanOrEqualTo<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustBeLessThan<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeLessThan<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustBeLessThanOrEqualTo<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeLessThanOrEqualTo<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
        ...
        public static abstract class MustBeBetween<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeBetween<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
         ...
         * "throws AbstractParameterN.Length.MustBeInDomain.Violation",
         * check parameter1 against a new
         * AbstractParameterN.Length.MustBeInDomain ( Between5And7Elements.CONTRACT )
         ...
         * AbstractParameterN.Length.AlwaysInDomain.Violation reveals more to
         * the caller about what the nature of the domain, and provides
         * an assertion filter for unit testing.
         * </p>
         *
         * @see musaico.foundation.filter
         * @see musaico.foundation.contract.obligations.AbstractParameterN.Length
         */
        public static abstract class MustBeInDomain<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
            extends AbstractParameterN.AbstractObligation<AbstractParameterN.Length.MustBeInDomain<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
            implements Serializable
        {
            private static final long serialVersionUID =
                AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainNoNulls<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainNoNulls<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustContainOnlyClasses<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustContainOnlyClasses<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
    ...
    public static abstract class MustExcludeClasses<ELEMENT extends Object, VIOLATION extends UncheckedViolation>
        extends AbstractParameterN.AbstractObligation<AbstractParameterN.MustExcludeClasses<ELEMENT, VIOLATION>, Object /* array or Collection */, VIOLATION>
        implements Serializable
    {
        private static final long serialVersionUID =
            AbstractParameterN.serialVersionUID;
