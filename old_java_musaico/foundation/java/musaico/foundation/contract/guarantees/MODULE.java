...
/**
 * <p>
 * Module settings for the musaico.foundation.contract.guarantees module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String COPYRIGHT =
        "Copyright (c) 2012-2018 Johann Tienhaara <jtienhaara@yahoo.com>";

    /** Human-readable description of the purpose of this module. */
    private static final String DESCRIPTION =
        "Assertions made by an object to its users, providing guarantees such as the domains of output values.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xF62EFCE0911A8FB504833CFDE42010380B2CC866";
    ...
    static final long VERSION = 20200422L;
