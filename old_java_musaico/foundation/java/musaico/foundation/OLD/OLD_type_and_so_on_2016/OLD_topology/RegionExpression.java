...
public class RegionExpression<POINT extends Serializable, MEASURE extends Serializable>
    extends Expression<Region<POINT, MEASURE>>
    implements Serializable
{
    ...
    public RegionExpression (
                             ...
                             Term<Region<POINT, MEASURE>> top_term
                             )
    ...
    public RegionExpression (
        ...
        throws ParametersMustNotBeNull.Violation
    {
        super ( new Identity<Region<POINT, MEASURE>> ( topology == null
                                                           ? null
                                                           : topology.regionSignature ().type () ),
                shared_metadata,
                top_term );
    ...
    public RegionExpression (
                             Topology<POINT, MEASURE> topology,
                             Operation2<Region<POINT, MEASURE>, Region<POINT, MEASURE>, Region<POINT, MEASURE>> operation,
                             Term<Region<POINT, MEASURE>> left,
                             Term<Region<POINT, MEASURE>> right,
                             Metadata shared_metadata
                             )
        throws ParametersMustNotBeNull.Violation
    {
        ...
        throws ParametersMustNotBeNull.Violation
    {
        final Term<Region<POINT, MEASURE>> region_term =
            this.topology.regionTerm ( region );
    ...
    {
        final Term<Region<POINT, MEASURE>> region_term =
            this.topology.regionTerm ( region_value );
        return this.intersection ( region_term );
    }
     ...
     *         as the right.  Never null.
     */
    @SuppressWarnings("unchecked") // Cast inputs().get(0) - Term<Region<P,M>>.
    public RegionExpression<POINT, MEASURE> intersection (
                                                          Term<Region<POINT, MEASURE>> region_term
                                                          )
        throws ParametersMustNotBeNull.Violation
    {
        final Operation2<Region<POINT, MEASURE>, Region<POINT, MEASURE>, Region<POINT, MEASURE>> intersection =
            this.topology.regionSignature ().intersection ();
        ...
        {
            final Term<Region<POINT, MEASURE>> initial_region_term =
                (Term<Region<POINT, MEASURE>>) this.inputs ().get ( 0 );
            new_expression =
     ...
     *         Never null.
     */
    public final NonBlocking<Region<POINT, MEASURE>> region ()
    {
        ...
        final NonBlocking<Region<POINT, MEASURE>> region =
