...
/**
 * <p>
 * Module settings for the musaico.foundation.typing.aspect module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "A bare bones mechanism for instrumenting an Operation, allowing \"pre\" and \"post\" aspects to be executed each time the Operation is executed.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x93A8F74E4825E97E79B6FD2735A9E0361C02C0A9";
    ...
    static final long VERSION = 20151225L;
