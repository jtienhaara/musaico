...
/**
 * <p>
 * A curryable Operation which takes 6 inputs.
 * </p>
 *
 *
 * <br> </br>
 ...
 */
public interface CurryableOperation6<INPUT1 extends Object, INPUT2 extends Object, INPUT3 extends Object, INPUT4 extends Object, INPUT5 extends Object, INPUT6 extends Object, OUTPUT extends Object>
    extends Operation6<INPUT1, INPUT2, INPUT3, INPUT4, INPUT5, INPUT6, OUTPUT>
{
    ...
    /**
     * <p>
     * Creates and returns a curried Operation which takes 5 inputs.
     * </p>
     *
     * @param input1 Input parameter # 1 to operate on.  Must not be null.
     *
     * @return One newly created, curried Operation5, or No operation
     *         if the specified input(s) are not valid by the input Type(s).
     *         Evaluating the returned Operation with the remaining
     *         input(s) actually evaluates this Operation6 with all inputs.
     *         Never null.
     *
     ...
     */
    public abstract ZeroOrOne<Operation5<INPUT2, INPUT3, INPUT4, INPUT5, INPUT6, OUTPUT>> evaluate (
                        Value<INPUT1> input1
                        )
     ...
     *         Never null.
     *
     * @see musaico.foundation.typing.Operation6#evaluate(musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value)
     */
    public abstract ZeroOrOne<Operation4<INPUT3, INPUT4, INPUT5, INPUT6, OUTPUT>> evaluate (
                        Value<INPUT1> input1,
                        Value<INPUT2> input2
                        )
        throws ParametersMustNotBeNull.Violation,
     ...
     * @see musaico.foundation.typing.Operation6#evaluate(musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value)
     */
    public abstract ZeroOrOne<Operation3<INPUT4, INPUT5, INPUT6, OUTPUT>> evaluate (
                        Value<INPUT1> input1,
                        Value<INPUT2> input2,
                        Value<INPUT3> input3
                        )
     ...
     * @see musaico.foundation.typing.Operation6#evaluate(musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value)
     */
    public abstract ZeroOrOne<Operation2<INPUT5, INPUT6, OUTPUT>> evaluate (
                        Value<INPUT1> input1,
                        Value<INPUT2> input2,
                        Value<INPUT3> input3,
                        Value<INPUT4> input4
     ...
     * @param input4 Input parameter # 4 to operate on.  Must not be null.
     *
     * @param input4 Input parameter # 5 to operate on.  Must not be null.
     *
     ...
     * @see musaico.foundation.typing.Operation6#evaluate(musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value, musaico.foundation.value.Value)
     */
    public abstract ZeroOrOne<Operation1<INPUT6, OUTPUT>> evaluate (
                        Value<INPUT1> input1,
                        Value<INPUT2> input2,
                        Value<INPUT3> input3,
                        Value<INPUT4> input4,
