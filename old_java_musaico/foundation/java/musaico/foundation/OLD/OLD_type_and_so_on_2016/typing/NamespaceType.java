...
/**
 * <p>
 * The Type representing all generic Namespaces (those which are
 * not Tags, Types, or other specialized Namespaces).
 * </p>
 *
 *
 * <p>
...
public class NamespaceType
    extends AbstractSymbolType<Namespace>
    implements Serializable
{
    ...
    private static final ObjectContracts classContracts =
        new ObjectContracts ( NamespaceType.class );
    ...
    /**
     * <p>
     * Creates a new NamespaceType with the specified type name and
     * SymbolTable.
     * </p>
     *
     * <p>
     * Package-private.  For Namespace.TYPE only.
     * </p>
     *
     ...
     *                     Must not be null.
     *
     * @param metadata The Metadata for this NamespaceType.
    ...
    /**
     * For Namespace.TYPE only.
     */
    NamespaceType finishConstructing ()
    {
     ...
     */
    @Override
    public final NamespaceType rename (
                                       String name
                                       )
     ...
     */
    @Override
    public final Class<Namespace> valueClass ()
        throws ReturnNeverNull.Violation
    {
