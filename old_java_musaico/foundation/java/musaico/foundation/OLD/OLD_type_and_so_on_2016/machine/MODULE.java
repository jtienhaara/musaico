...
/**
 * <p>
 * Module settings for the musaico.foundation.machine module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "State machine structures which handle input and navigate through graphs of state transitions.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x67038554569AFAACDC12BAA2BD48E15619935B1F";
    ...
    static final long VERSION = 20160606L;
