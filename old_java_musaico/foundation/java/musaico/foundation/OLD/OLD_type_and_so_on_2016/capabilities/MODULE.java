package musaico.foundation.term.capabilities;
...
/**
 * <p>
 * Module settings for the musaico.foundation.term.capabilities module.
 * </p>
 *
 *
 * <p>
 ...
 * </p>
 *
 * @see musaico.foundation.term.capabilities.MODULE#COPYRIGHT
 * @see musaico.foundation.term.capabilities.MODULE#LICENSE
 */
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Capabilities which involve Terms, such as reading/writing the asynchronous result of a Blocking value, or publishing the eventual result to a subscriber once the value has finished Blocking, and so on.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xEA1358940542456367394BE182397753BF974875";
    ...
    static final long VERSION = 20161204L;
