    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Intersection operation with the default name.
     * </p>
     */
    public Intersection ()
    {
        this ( TopologyTypeClass.RegionClass.INTERSECTION.name () );
    }


    /**
     * <p>
     * Creates a new Intersection operation with the specified name.
     * </p>
     *
                                             ...
                                             )
    {
                ...
                || input2.hasNext () )
        {
            ...
            {
                output = this.intersection ( input1.next (),
                                             input2.next () );
            }
     ...
     * </p>
     *
     * @param region1 The 1st Region to intersect.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to intersect.
     *                Must not be null.
     *
     * @return The intersection of the two specified Regions.
