    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Scale operation with the default name.
     * </p>
     */
    public Scale ()
    {
        this ( TopologyTypeClass.RegionClass.SCALE.name () );
    }


    /**
     * <p>
     * Creates a new Scale operation with the specified name.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the scale of two Regions.
     * </p>
     *
     * @param region1 The 1st Region to scale.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to scale.
     *                Must not be null.
     *
     * @return The scale of the two specified Regions.
