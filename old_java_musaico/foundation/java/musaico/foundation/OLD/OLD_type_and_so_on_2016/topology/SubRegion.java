    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new SubRegion operation with the default name.
     * </p>
     */
    public SubRegion ()
    {
        this ( TopologyTypeClass.RegionClass.SUB_REGION.name () );
    }


    /**
     * <p>
     * Creates a new SubRegion operation with the specified name.
     * </p>
     *
                                             ...
                                             )
    {
                ...
                || input2.hasNext () )
        {
            ...
            {
                output = this.subRegion ( input1.next (),
                                          input2.next () );
            }
    ...
    /**
     * <p>
     * Returns the sub region of two Regions.
     * </p>
     *
     * @param region1 The 1st Region to sub region.
     *                Must not be null.
     *
     * @param region2 The 2nd Region to sub region.
     *                Must not be null.
     *
     * @return The sub region of the two specified Regions.
