    ...
    implements OperationBody2<Region, Region, Region>, Serializable
{
    ...
    /**
     * <p>
     * Creates a new Exclude operation with the default name.
     * </p>
     */
    public Exclude ()
    {
        this ( TopologyTypeClass.RegionClass.EXCLUDE.name () );
    }


    /**
     * <p>
     * Creates a new Exclude operation with the specified name.
     * </p>
     *
                                             ...
                                             )
    {
                ...
                || input2.hasNext () )
        {
            ...
            {
                output = this.exclude ( input1.next (),
                                        input2.next () );
            }
    ...
    /**
     * <p>
     * Returns the exclude of two Regions.
     * </p>
     *
     * @param region1 The Region from which part will be excluded.
     *                Must not be null.
     *
     * @param region2 The Region to exclude from the 1st region.
     *                Must not be null.
     *
     * @return The exclude of the two specified Regions.
     *         Can be empty.  Never null.
     */
    public Region exclude (
                           Region region1,
                           Region region2
                           )
    {
