...
/**
 * <p>
 * Module settings for the musaico.foundation.pipeline module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Chains of functions or Operations, each of which takes a certain class of input, and produces the same class of output.  Pipelines distribute the load of editing, filtering, ordering and selecting among several discrete interfaces.  Pipelines were primarily designed as support for Types, Terms and Operations, but can be extended in other ways if desired.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xF4F89FAFC9D21287AC670C8D1731B1486CC556DE";
    ...
    static final long VERSION = 20170521L;
