    ...
    extends Serializable
{
     ...
     *         then all of its SubPipeline children (if it as any)
     *         that have already been <code> end () </code>ed
     *         will also be duplicated.  If this Source is also a SubPipeline
     *         then no parent or ancestor Pipelines are copied,
     *         only this SubPipeline and all of its SubPipeline
