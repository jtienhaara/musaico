 ...
 * </p>
 *
 * @see musaico.foundation.pipeline.Sink#fork(musaico.foundation.pipeline.Sink[])
 *
 *
 * <p>
 ...
 */
public class TermFork<VALUE extends Object, PARENT extends TermPipeline<VALUE, PARENT> & Sink<VALUE, PARENT, Term<VALUE>, TermPipeline.TermSink<VALUE>, OperationPipeline.OperationSink<VALUE>>>
    extends AbstractTermBranch<VALUE, TermFork<VALUE, PARENT>, VALUE, PARENT, OperationPipeline.OperationFork<VALUE>>
    implements Fork<VALUE, PARENT, Term<VALUE>, TermPipeline.TermSink<VALUE>, OperationPipeline.OperationSink<VALUE>, TermFork<VALUE, PARENT>>, Serializable
{
    ...
    /**
     * @see musaico.foundation.pipeline.Fork#fork(musaico.foundation.pipeline.Source[])
     */
    @Override
    @SuppressWarnings("unchecked") // Generic array heap pollution.
    public final TermFork<VALUE, PARENT> fork (
    ...
    private final <SLAVE extends OperationPipeline.OperationFork<VALUE>, SLAVE_PARENT extends OperationPipeline.OperationSink<VALUE>>
