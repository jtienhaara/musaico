 ...
 */
public class ValueMustBeOne
    implements Contract<Term<?>, ValueMustBeOne.Violation>, Serializable
{
    ...
    /** The ValueMustBeOne contract. */
    public static final ValueMustBeOne CONTRACT =
        new ValueMustBeOne ();
    ...
    {
        return "The term must be One, a result which contains"
     ...
     */
    @Override
    public ValueMustBeOne.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new ValueMustBeOne.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final ValueMustBeOne.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeOne contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeOne.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeOne.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not One.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
