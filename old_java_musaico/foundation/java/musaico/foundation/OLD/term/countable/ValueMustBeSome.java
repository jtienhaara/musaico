 ...
 */
public class ValueMustBeSome
    implements Contract<Term<?>, ValueMustBeSome.Violation>, Serializable
{
    ...
    /** The ValueMustBeSome contract. */
    public static final ValueMustBeSome CONTRACT =
        new ValueMustBeSome ();
    ...
    {
        return "The term must be Some, a result which contains"
     ...
     */
    @Override
    public ValueMustBeSome.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new ValueMustBeSome.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final ValueMustBeSome.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeSome contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeSome.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeSome.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Some.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
