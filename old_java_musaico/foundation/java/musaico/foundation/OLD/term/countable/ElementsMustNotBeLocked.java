...
/**
 * <p>
 * All <code> Elements.lock () </code> must have been closed, so that
 * no thread currently owns each Elements.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ElementsMustNotBeLocked
    implements Contract<Elements<?>, ElementsMustNotBeLocked.Violation>, Serializable
{
    ...
    /** The ElementsMustNotBeLocked contract. */
    public static final ElementsMustNotBeLocked CONTRACT =
        new ElementsMustNotBeLocked ();
    ...
    {
        return "The Elements must not be locked by any thread.";
    }
            ...
            )
    {
        ...
        else if ( elements.lockOwner () != null )
        {
            return FilterState.DISCARDED;
        }
     ...
     */
    @Override
    public ElementsMustNotBeLocked.Violation violation (
            Object plaintiff,
            Elements<?> evidence
            )
    {
        return new ElementsMustNotBeLocked.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    {
        final ElementsMustNotBeLocked.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ElementsMustNotBeLocked contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ElementsMustNotBeLocked.serialVersionUID;


        /**
         * <p>
         * Creates a new ElementsMustNotBeLocked.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The elements were locked.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
