...
/**
 * <p>
 * A guarantee of a Countable term (with 0 or more elements, not
 ...
 */
public class ValueMustBeCountable
    implements Contract<Term<?>, ValueMustBeCountable.Violation>, Serializable
{
    ...
    /** The ValueMustBeCountable contract. */
    public static final ValueMustBeCountable CONTRACT =
        new ValueMustBeCountable ();
    ...
    {
        return "The term must be Countable, containing between"
            + " 0 and " + Long.MAX_VALUE + " elements, inclusive.";
    }
     ...
     */
    @Override
    public ValueMustBeCountable.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustBeCountable.Violation ( this,
                                                    plaintiff,
                                                    evidence );
    }
    ...
    /**
     * <p>
     * A violation of the ValueMustBeCountable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeCountable.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeCountable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Countable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
