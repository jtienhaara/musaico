...
/**
 * <p>
 * Each element of each inspected Term must be of one of a specific
 * set of Classes, or a TermViolation will be generated.
 * </p>
 *
 ...
 */
public class CountableMustContainOnlySpecificClasses
    implements Contract<Term<?>, CountableMustContainOnlySpecificClasses.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( CountableMustContainOnlySpecificClasses.class );


    // The ContainsOnlySpecificClasses Domain to which every
    // Term must belong.
    ...
    /**
     * <p>
     * Creates a new CountableMustContainOnlySpecificClasses contract.
     * </p>
     *
     * @param required_classes The Class(es) of which every element
     *                         in every Term must be an instance.
     *                         Must not be null.  Must not contain
     *                         any null elements.
     */
    public CountableMustContainOnlySpecificClasses (
            Class<?> ... required_classes
            )
        throws ParametersMustNotBeNull.Violation
    {
        this (
              new ContainsOnlySpecificClasses (
                                               required_classes ) );
    }
     ...
     * </p>
     *
     * @param domain The ContainsOnlySpecificClasses Domain to which
     *               every inspected Term must belong.
     *               Must not be null.
     */
    public CountableMustContainOnlySpecificClasses (
    ...
    /**
     * @see musaico.foundation.domains.array.ContainsOnlySpecificClasses#classesToString()
     */
    ...
    {
        return "Term must contain only elements of classes { "
     ...
     *         Never null.
     */
    public final ContainsOnlySpecificClasses domain ()
    {
        return this.domain;
    }
            ...
            )
    {
        ...
        final CountableMustContainOnlySpecificClasses that =
            (CountableMustContainOnlySpecificClasses) obj;
    ...
    /**
     * @see musaico.foundation.domains.array.ContainsOnlySpecificClasses#requiredClasses()
     */
    public final Class<?> [] requiredClasses ()
    {
        return this.domain.requiredClasses ();
    }
     ...
     */
    @Override
    public CountableMustContainOnlySpecificClasses.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new CountableMustContainOnlySpecificClasses.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final CountableMustContainOnlySpecificClasses.Violation violation =
    ...
    /**
     * <p>
     * A violation of the CountableMustContainOnlySpecificClasses contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            CountableMustContainOnlySpecificClasses.serialVersionUID;


        /**
         * <p>
         * Creates a new CountableMustContainOnlySpecificClasses.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          CountableMustContainOnlySpecificClasses contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
