...
/**
 * <p>
 * A guarantee that every Type meets exactly one Contract
 * (not zero, not more than one) in a specific set of child Contracts.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TypeMustMeetExactlyOneContract
    implements Contract<Type<?>, TypeMustMeetExactlyOneContract.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustMeetExactlyOneContract.class );
    ...
    /**
     * <p>
     * Creates a new TypeMustMeetExactlyOneContract.
     * </p>
     *
     * @param child_contracts The child contracts which comprise this
     *                        TypeMustMeetExactlyOneContract composite
    ...
    public TypeMustMeetExactlyOneContract (
    ...
    public final String description ()
    {
        ...
        return "The type must meet exactly one Contract: "
            + sbuf.toString ();
    }
            ...
            )
    {
        ...
        final TypeMustMeetExactlyOneContract that =
            (TypeMustMeetExactlyOneContract) obj;
        for ( int c = 0;
     ...
     */
    @Override
    public TypeMustMeetExactlyOneContract.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustMeetExactlyOneContract.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TypeMustMeetExactlyOneContract.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustMeetExactlyOneContract contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustMeetExactlyOneContract.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustMeetExactlyOneContract.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The type did not meet"
                    + " exactly one Contract.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
