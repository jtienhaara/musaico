...
/**
 * <p>
 * Each "left" Type must be compatible with each "right" Type.
 * </p>
 *
 * <p>
 ...
 * will still be considered compatible, and TypesMustMatch will
 ...
 */
public class TypesMustMatch
    implements Contract<LeftAndRight<Type<?>, Type<?>>, TypesMustMatch.Violation>, Serializable
{
    ...
    /** The singleton TypesMustMatch contract. */
    public static final TypesMustMatch CONTRACT =
        new TypesMustMatch ();


    /**
     * <p>
     * Creates TypesMustMatch.CONTRACT.
     * </p>
     */
    private TypesMustMatch ()
    {
    }
    ...
    {
        return "Each left Type must be compatible with the right Type.";
    }
     ...
     */
    @Override
    public TypesMustMatch.Violation violation (
            Object plaintiff,
            LeftAndRight<Type<?>, Type<?>> evidence
            )
    {
        return new TypesMustMatch.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TypesMustMatch.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypesMustMatch contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypesMustMatch.serialVersionUID;


        /**
         * <p>
         * Creates a new TypesMustMatch.Violation.
         * </p>
         *
            ...
            throws ParametersMustNotBeNull.Violation
        {
            super ( contract,
                    ...
                    + " is not compatible with the left Type "
                    + ( evidence == null
                            ? "null"
