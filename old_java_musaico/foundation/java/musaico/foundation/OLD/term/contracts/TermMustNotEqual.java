 ...
 */
public class TermMustNotEqual
    implements Contract<Term<?>, TermMustNotEqual.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TermMustNotEqual.class );


    // The NotEqualTo Domain to which ever Term must belong.
    private final NotEqualTo domain;


    /**
     * <p>
     * Creates a new TermMustNotEqual contract.
     * </p>
     *
     * @param term The Term to which every inspected Term
     *              must be equal.  Must not be null.
     */
    public TermMustNotEqual (
                              Term<?> term
                              )
     ...
     * </p>
     *
     * @param domain The NotEqualTo Domain to which every inspected Term
            ...
            )
    {
        ...
        final TermMustNotEqual that =
            (TermMustNotEqual) obj;
     ...
     */
    @Override
    public TermMustNotEqual.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotEqual.Violation ( this,
                                              plaintiff,
                                              evidence );
    }
    ...
    {
        final TermMustNotEqual.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotEqual contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotEqual.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotEqual.Violation.
         * </p>
         *
