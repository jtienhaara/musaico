...
/**
 * <p>
 * A general-purpose Contract for Terms: each Term
 * (NOT the term, nor the value's elements) must be DISCARDED
 * by specific Filter(s), or a TermViolation will be generated.
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotMatchFilters
    implements Contract<Term<?>, ValueMustNotMatchFilters.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( ValueMustNotMatchFilters.class );


    // The Filter(s) which must NOT match each Term.
    private final Filter<Term<?>> [] filters;


    /**
     * <p>
     * Creates a new ValueMustNotMatchFilters contract.
     * </p>
     *
     * @param filters The Filter(s) which must NOT match each Term.
     *                Must not be null.  Must not contain any null elements.
     */
    @SuppressWarnings({"rawtypes", "unchecked"}) // Generic array creation.
    public ValueMustNotMatchFilters (
                                     Filter<Term<?>> ... filters
                                     )
                                 ...
                                 )
    {
        ...
        final ValueMustNotMatchFilters that =
            (ValueMustNotMatchFilters) obj;
    ...
    /**
     * @return The Filter(s) which must NOT match each Term.
     ...
     */
    @Override
    public final ValueMustNotMatchFilters.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustNotMatchFilters.Violation ( this,
                                                        plaintiff,
                                                        evidence );
    }
    ...
    {
        final ValueMustNotMatchFilters.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotMatchFilters contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotMatchFilters.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotMatchFilters.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          ValueMustNotMatchFilters contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
        ...
        {
            super ( contract,
                    "The filters did match the Term.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
