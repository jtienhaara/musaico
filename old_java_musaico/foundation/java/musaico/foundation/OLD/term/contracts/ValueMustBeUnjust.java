...
/**
 * <p>
 * A guarantee of a Term with an Unjust value (such as a Partial result,
 * or an Error, or No value, and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeUnjust
    implements Contract<Term<?>, ValueMustBeUnjust.Violation>, Serializable
{
    ...
    /** The ValueMustBeUnjust contract. */
    public static final ValueMustBeUnjust CONTRACT =
        new ValueMustBeUnjust ();
    ...
    {
        return "The term must be Unjust:"
            + " either 0 elements or a partial value.";
    }
     ...
     */
    @Override
    public ValueMustBeUnjust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustBeUnjust.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    {
        final ValueMustBeUnjust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustBeUnjust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeUnjust.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeUnjust.Violation.
         * </p>
         *
