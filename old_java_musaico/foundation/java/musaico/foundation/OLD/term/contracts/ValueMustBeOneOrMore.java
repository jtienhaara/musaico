...
/**
 * <p>
 * A guarantee of a Term with OneOrMore value(s) (such as any Term with
 * One value or Many values, but excluding any Term with Some value(s),
 * since a variable-length Some can be empty, and so Some is not OneOrMore).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustBeOneOrMore
    implements Contract<Term<?>, ValueMustBeOneOrMore.Violation>, Serializable
{
    ...
    /** The ValueMustBeOneOrMore contract. */
    public static final ValueMustBeOneOrMore CONTRACT =
        new ValueMustBeOneOrMore ();
    ...
    {
        return "The term must be OneOrMore, containing at least"
            + " one element(s), and Countable.";
    }
     ...
     */
    @Override
    public ValueMustBeOneOrMore.Violation violation (
                                                 Object plaintiff,
                                                 Term<?> evidence
                                                 )
    {
        return new ValueMustBeOneOrMore.Violation ( this,
                                                plaintiff,
                                                evidence );
    }
    ...
    /**
     * <p>
     * A violation of the ValueMustBeOneOrMore contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustBeOneOrMore.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustBeOneOrMore.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not OneOrMore.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
