 ...
 * that returns <code> isKept () == false </code>.
 * </p>
 *
 ...
 */
public class TermFilterStateMustNotBeKept
    implements Contract<Term<?>, TermFilterStateMustNotBeKept.Violation>, Serializable
{
    ...
    /** The TermFilterStateMustNotBeKept contract. */
    public static final TermFilterStateMustNotBeKept CONTRACT =
        new TermFilterStateMustNotBeKept ();


    // Creates the TermFilterStateMustNotBeKept singleton contract.
    private TermFilterStateMustNotBeKept ()
    {
    }
    ...
    {
        return "The term's filterState () must return isKept () == false.";
    }
     ...
     */
    @Override
    public TermFilterStateMustNotBeKept.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermFilterStateMustNotBeKept.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TermFilterStateMustNotBeKept.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermFilterStateMustNotBeKept contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermFilterStateMustNotBeKept.serialVersionUID;


        /**
         * <p>
         * Creates a new TermFilterStateMustNotBeKept.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          TermFilterStateMustNotBeKept contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
