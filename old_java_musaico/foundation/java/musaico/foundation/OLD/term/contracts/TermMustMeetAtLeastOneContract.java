...
/**
 * <p>
 * A guarantee that every Term meets at least one Contract in a specific set
 * of child Contracts.
 * </p>
 *
 *
 ...
 */
public class TermMustMeetAtLeastOneContract
    implements Contract<Term<?>, TermMustMeetAtLeastOneContract.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TermMustMeetAtLeastOneContract.class );
    ...
    /**
     * <p>
     * Creates a new TermMustMeetAtLeastOneContract.
     * </p>
     *
     * @param child_contracts The child contracts which comprise this
     *                        TermMustMeetAtLeastOneContract composite
    ...
    public TermMustMeetAtLeastOneContract (
    ...
    public final String description ()
    {
        ...
        return "The term must meet at least one Contract: "
            + sbuf.toString ();
    }
            ...
            )
    {
        ...
        final TermMustMeetAtLeastOneContract that =
            (TermMustMeetAtLeastOneContract) obj;
        for ( int c = 0;
     ...
     */
    @Override
    public TermMustMeetAtLeastOneContract.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustMeetAtLeastOneContract.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TermMustMeetAtLeastOneContract.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustMeetAtLeastOneContract contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustMeetAtLeastOneContract.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustMeetAtLeastOneContract.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term did not meet at least one Contract.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
