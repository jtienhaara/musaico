...
/**
 * <p>
 * A guarantee that every Term meets all Contracts in a specific set
 * of child Contracts.
 * </p>
 *
 *
 ...
 */
public class TermMustMeetAllContracts
    implements Contract<Term<?>, TermMustMeetAllContracts.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TermMustMeetAllContracts.class );
    ...
    /**
     * <p>
     * Creates a new TermMustMeetAllContracts.
     * </p>
     *
     * @param child_contracts The child contracts which comprise this
     *                        TermMustMeetAllContracts composite contract.
    ...
    public TermMustMeetAllContracts (
    ...
    public final String description ()
    {
        ...
        return "The term must meet all Contracts: "
            + sbuf.toString ();
    }
            ...
            )
    {
        ...
        final TermMustMeetAllContracts that = (TermMustMeetAllContracts) obj;
        for ( int c = 0;
     ...
     */
    @Override
    public TermMustMeetAllContracts.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustMeetAllContracts.Violation ( this,
                                                         plaintiff,
                                                         evidence );
    }
    ...
    {
        final TermMustMeetAllContracts.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustMeetAllContracts contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustMeetAllContracts.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustMeetAllContracts.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term did not meet all of the Contracts.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
