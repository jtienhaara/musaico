...
/**
 * <p>
 * A guarantee that every Type meets none of the Contracts in a specific set
 * of child Contracts.
 * </p>
 *
 *
 ...
 */
public class TypeMustNotMeetAnyContract
    implements Contract<Type<?>, TypeMustNotMeetAnyContract.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustNotMeetAnyContract.class );
    ...
    /**
     * <p>
     * Creates a new TypeMustNotMeetAnyContract.
     * </p>
     *
     * @param child_contracts The child contracts which comprise this
     *                        TypeMustNotMeetAnyContract composite contract.
     *                        Used to check that each Type meets this
    ...
    public TypeMustNotMeetAnyContract (
    ...
    public final String description ()
    {
        ...
        return "The type must not meet any Contract: "
            + sbuf.toString ();
    }
            ...
            )
    {
        ...
        final TypeMustNotMeetAnyContract that =
            (TypeMustNotMeetAnyContract) obj;
        for ( int c = 0;
     ...
     */
    @Override
    public TypeMustNotMeetAnyContract.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustNotMeetAnyContract.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final TypeMustNotMeetAnyContract.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustNotMeetAnyContract contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustNotMeetAnyContract.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustNotMeetAnyContract.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The type met one (or more) verboten Contract(s).", // description
                    plaintiff,
                    evidence,
                    cause );
        }
