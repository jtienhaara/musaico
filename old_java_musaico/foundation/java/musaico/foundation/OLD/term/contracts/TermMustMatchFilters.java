...
/**
 * <p>
 * A general-purpose Contract for Terms: each Term must be KEPT
 ...
 */
public class TermMustMatchFilters
    implements Contract<Term<?>, TermMustMatchFilters.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TermMustMatchFilters.class );


    // The Filter(s) which must match each Term.
    private final Filter<Term<?>> [] filters;


    /**
     * <p>
     * Creates a new TermMustMatchFilters contract.
     * </p>
     *
    ...
    public final String description ()
    {
        ...
        return "Each term must be matched by all of the filter(s): { "
                                 ...
                                 )
    {
        ...
        final TermMustMatchFilters that =
            (TermMustMatchFilters) obj;
    ...
    /**
     * @return The Filter(s) which must match each whole Term.
     ...
     */
    @Override
    public final TermMustMatchFilters.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustMatchFilters.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustMatchFilters.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustMatchFilters contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustMatchFilters.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustMatchFilters.Violation.
         * </p>
         *
