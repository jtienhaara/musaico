...
/**
 * <p>
 * A guarantee of any term except a Countable value (allowing
 * abnormal terms such as Warning and Error, as well as Indefinite
 * and Infinite values, and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class ValueMustNotBeCountable
    implements Contract<Term<?>, ValueMustNotBeCountable.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeCountable contract. */
    public static final ValueMustNotBeCountable CONTRACT =
        new ValueMustNotBeCountable ();
    ...
    {
        return "The term must not be Countable.";
    }
     ...
     */
    @Override
    public ValueMustNotBeCountable.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ValueMustNotBeCountable.Violation ( this,
                                                       plaintiff,
                                                       evidence );
    }
    ...
    {
        final ValueMustNotBeCountable.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeCountable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeCountable.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeCountable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Countable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
