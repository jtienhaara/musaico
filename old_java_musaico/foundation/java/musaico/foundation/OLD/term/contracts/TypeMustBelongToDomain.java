 ...
 * must belong to a specific Domain, or an UncheckedViolation
 * will be generated.
 * </p>
 *
 *
 ...
 */
public class TypeMustBelongToDomain
    implements Contract<Type<?>, TypeMustBelongToDomain.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( TypeMustBelongToDomain.class );
    ...
    /**
     * <p>
     * Creates a new TypeMustBelongToDomain contract.
     * </p>
     *
     * @param domain The domain to which every inspected Type must belong.
     *               Must not be null.
     */
    public TypeMustBelongToDomain (
            Domain<Type<?>> domain
            )
    ...
    {
        return "Each type must belong to the domain of Types "
            + this.domain
            + ".";
    }
                                 ...
                                 )
    {
        ...
        final TypeMustBelongToDomain that =
            (TypeMustBelongToDomain) obj;
     ...
     */
    @Override
    public final TypeMustBelongToDomain.Violation violation (
            Object plaintiff,
            Type<?> evidence
            )
    {
        return new TypeMustBelongToDomain.Violation (
                       this,
                       plaintiff,
                       evidence );
    }
    ...
    {
        final TypeMustBelongToDomain.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TypeMustBelongToDomain contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TypeMustBelongToDomain.serialVersionUID;


        /**
         * <p>
         * Creates a new TypeMustBelongToDomain.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          TypeMustBelongToDomain contract,
                          Object plaintiff,
                          Type<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
