...
/**
 * <p>
 * A guarantee of any term that is NOT Definite (Definite terms
 ...
 */
public class ValueMustNotBeDefinite
    implements Contract<Term<?>, ValueMustNotBeDefinite.Violation>, Serializable
{
    ...
    /** The ValueMustNotBeDefinite contract. */
    public static final ValueMustNotBeDefinite CONTRACT =
        new ValueMustNotBeDefinite ();
    ...
    {
        return "The term must not be Definite; its number of elements"
     ...
     */
    @Override
    public ValueMustNotBeDefinite.Violation violation (
                                                       Object plaintiff,
                                                       Term<?> evidence
                                                       )
    {
        return new ValueMustNotBeDefinite.Violation ( this,
                                                      plaintiff,
                                                      evidence );
    }
    ...
    {
        final ValueMustNotBeDefinite.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ValueMustNotBeDefinite contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ValueMustNotBeDefinite.serialVersionUID;


        /**
         * <p>
         * Creates a new ValueMustNotBeDefinite.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Definite.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
