 ...
 * of each Term must be DISCARDED by specific Filter(s),
 ...
 */
public class ElementsMustNotMatchFilters<ELEMENT extends Object>
    implements Contract<Term<?>, ElementsMustNotMatchFilters.Violation>, Serializable
{
    ...
    private static final Advocate classContracts =
        new Advocate ( ElementsMustNotMatchFilters.class );


    // The Filter(s) which must NOT match each element of every Term.
    private final Filter<ELEMENT> [] filters;


    /**
     * <p>
     * Creates a new ElementsMustNotMatchFilters contract.
     * </p>
     *
    ...
    public ElementsMustNotMatchFilters (
    ...
    /**
     * @return The Filter which must NOT match each element
                                 ...
                                 )
    {
        ...
        final ElementsMustNotMatchFilters<?> that =
            (ElementsMustNotMatchFilters<?>) obj;
        ...
        try
        {
            for ( Object element_object : term )
            {
                ...
                for ( Filter<ELEMENT> filter : this.filters )
                {
                    ...
                    {
                        return filter_state.opposite (); // NOT filter matches.
                    }
                }
            }
        }
    ...
    /**
     * @return The Filter(s) which must not match any element
     *         of every Term.  Never null.
    ...
    {
        return 43 * ClassName.of ( this.getClass () ).hashCode ()
            + this.filters.length;
    }
     ...
     */
    @Override
    public final ElementsMustNotMatchFilters.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new ElementsMustNotMatchFilters.Violation ( this,
                                                           plaintiff,
                                                           evidence );
    }
    ...
    {
        final ElementsMustNotMatchFilters.Violation violation =
    ...
    /**
     * <p>
     * A violation of the ElementsMustNotMatchFilters contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            ElementsMustNotMatchFilters.serialVersionUID;


        /**
         * <p>
         * Creates a new ElementsMustNotMatchFilters.Violation.
         * </p>
         *
         ...
         */
        public Violation (
                          ElementsMustNotMatchFilters<?> contract,
                          Object plaintiff,
                          Term<?> evidence
                          )
            throws ParametersMustNotBeNull.Violation
        ...
        {
            super ( contract,
                    "The matched one or more elements of the Term: "
                    + ( contract == null
                        ? evidence
