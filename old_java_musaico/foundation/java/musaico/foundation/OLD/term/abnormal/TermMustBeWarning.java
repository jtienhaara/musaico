 ...
 */
public class TermMustBeWarning
    implements Contract<Term<?>, TermMustBeWarning.Violation>, Serializable
{
    ...
    /** The TermMustBeWarning contract. */
    public static final TermMustBeWarning CONTRACT =
        new TermMustBeWarning ();
    ...
    {
        return "The term must be a Warning, which does contain"
            + " a just term as its consequence, but also carries"
            + " a violation of some contract which can only be"
            + " ignored if the recipient of the term deliberately"
                               ...
                               )
    {
        ...
        else if ( term instanceof Warning )
        {
     ...
     */
    @Override
    public TermMustBeWarning.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBeWarning.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final TermMustBeWarning.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeWarning contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeWarning.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeWarning.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not a Warning.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
