 ...
 */
public class TermMustBeError
    implements Contract<Term<?>, TermMustBeError.Violation>, Serializable
{
    ...
    /** The TermMustBeError contract. */
    public static final TermMustBeError CONTRACT =
        new TermMustBeError ();
    ...
    {
        return "The term must be an Error, the result of an attempt"
            + " to return a term which failed due to bad inputs or"
            + " bad state.";
    }
     ...
     */
    @Override
    public TermMustBeError.Violation violation (
                                                 Object plaintiff,
                                                 Term<?> evidence
                                                 )
    {
        return new TermMustBeError.Violation ( this,
                                                plaintiff,
                                                evidence );
    }
    ...
    {
        final TermMustBeError.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeError contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeError.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeError.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not an Error.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
