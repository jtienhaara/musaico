...
/**
 * <p>
 * A guarantee of an Wrapped term, such as a Warning or a Partial value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeWrapped
    implements Contract<Term<?>, TermMustBeWrapped.Violation>, Serializable
{
    ...
    /** The TermMustBeWrapped contract. */
    public static final TermMustBeWrapped CONTRACT =
        new TermMustBeWrapped ();
    ...
    {
        return "The term must be Wrapped, such as a warning"
            + " or a partial value.";
    }
     ...
     */
    @Override
    public TermMustBeWrapped.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustBeWrapped.Violation (
                this,
                plaintiff,
                evidence );
    }
    ...
    /**
     * <p>
     * A violation of the TermMustBeWrapped contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeWrapped.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeWrapped.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Wrapped.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
