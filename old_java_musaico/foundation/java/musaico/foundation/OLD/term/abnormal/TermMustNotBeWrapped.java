 ...
 */
public class TermMustNotBeWrapped
    implements Contract<Term<?>, TermMustNotBeWrapped.Violation>, Serializable
{
    ...
    /** The TermMustNotBeWrapped contract. */
    public static final TermMustNotBeWrapped CONTRACT =
        new TermMustNotBeWrapped ();
    ...
    {
        return "The term must not be Wrapped.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Wrapped )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public TermMustNotBeWrapped.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotBeWrapped.Violation (
                       this,
                       plaintiff,
                       evidence );
    }
    ...
    {
        final TermMustNotBeWrapped.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeWrapped contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeWrapped.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeWrapped.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Wrapped.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
