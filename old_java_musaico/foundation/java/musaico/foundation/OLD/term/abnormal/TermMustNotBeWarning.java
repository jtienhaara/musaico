...
/**
 * <p>
 * A guarantee of any value EXCEPT a Warning, even possibly an Unjust
 ...
 */
public class TermMustNotBeWarning
    implements Contract<Term<?>, TermMustNotBeWarning.Violation>, Serializable
{
    ...
    /** The TermMustNotBeWarning contract. */
    public static final TermMustNotBeWarning CONTRACT =
        new TermMustNotBeWarning ();
    ...
    {
        return "The term must not be a Warning.";
    }
     ...
     */
    @Override
    public TermMustNotBeWarning.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new TermMustNotBeWarning.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustNotBeWarning.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeWarning contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeWarning.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeWarning.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was a Warning.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
