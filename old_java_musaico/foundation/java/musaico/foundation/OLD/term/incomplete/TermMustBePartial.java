...
/**
 * <p>
 * A guarantee of a partial value (more than No value, but less than One).
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBePartial
    implements Contract<Term<?>, TermMustBePartial.Violation>, Serializable
{
    ...
    /** The TermMustBePartial contract. */
    public static final TermMustBePartial CONTRACT =
        new TermMustBePartial ();
    ...
    {
        return "The term must be Partial, a result which contains"
            + " some of the elements requested, but not all of them.";
    }
     ...
     */
    @Override
    public TermMustBePartial.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBePartial.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final TermMustBePartial.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBePartial contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBePartial.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBePartial.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Partial.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
