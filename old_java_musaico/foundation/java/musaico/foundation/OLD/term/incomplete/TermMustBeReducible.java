...
/**
 * <p>
 * A guarantee of a reducible value (such as an Expression).
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeReducible
    implements Contract<Term<?>, TermMustBeReducible.Violation>, Serializable
{
    ...
    /** The TermMustBeReducible contract. */
    public static final TermMustBeReducible CONTRACT =
        new TermMustBeReducible ();
    ...
    {
        return "The term must be Reducible, a result which contains"
     ...
     */
    @Override
    public TermMustBeReducible.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBeReducible.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    /**
     * <p>
     * A violation of the TermMustBeReducible contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeReducible.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeReducible.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Reducible.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
