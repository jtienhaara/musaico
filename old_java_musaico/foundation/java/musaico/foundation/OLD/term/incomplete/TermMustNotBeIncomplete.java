...
/**
 * <p>
 * A guarantee of any term except an incomplete term
 ...
 */
public class TermMustNotBeIncomplete
    implements Contract<Term<?>, TermMustNotBeIncomplete.Violation>, Serializable
{
    ...
    /** The TermMustNotBeIncomplete contract. */
    public static final TermMustNotBeIncomplete CONTRACT =
        new TermMustNotBeIncomplete ();
    ...
    {
        return "The term must not be Incomplete.";
    }
     ...
     */
    @Override
    public TermMustNotBeIncomplete.Violation violation (
                                                         Object plaintiff,
                                                         Term<?> evidence
                                                         )
    {
        return new TermMustNotBeIncomplete.Violation ( this,
                                                        plaintiff,
                                                        evidence );
    }
    ...
    {
        final TermMustNotBeIncomplete.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeIncomplete contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeIncomplete.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeIncomplete.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Incomplete.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
