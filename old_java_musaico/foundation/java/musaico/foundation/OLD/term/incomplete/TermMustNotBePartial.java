...
/**
 * <p>
 * A guarantee of anything but a partial value (include One, Many, No results,
 * Errors, Blocking results, and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBePartial
    implements Contract<Term<?>, TermMustNotBePartial.Violation>, Serializable
{
    ...
    /** The TermMustNotBePartial contract. */
    public static final TermMustNotBePartial CONTRACT =
        new TermMustNotBePartial ();
    ...
    {
        return "The term must not be Partial.";
    }
     ...
     */
    @Override
    public TermMustNotBePartial.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new TermMustNotBePartial.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustNotBePartial.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBePartial contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBePartial.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBePartial.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Partial.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
