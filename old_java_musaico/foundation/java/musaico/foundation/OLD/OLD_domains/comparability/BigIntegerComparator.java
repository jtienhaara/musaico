    ...
    implements Comparator<Number>, Serializable
{
    ...
    /** The singleton BigIntegerComparator. */
    public static final BigIntegerComparator COMPARATOR =
        new BigIntegerComparator ();


    // Creates the BigIntegerComparator singleton.
    // Use BigIntegerComparator.COMPARATOR instead.
