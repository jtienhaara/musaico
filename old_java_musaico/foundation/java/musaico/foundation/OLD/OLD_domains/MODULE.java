...
/**
 * <p>
 * Module settings for the musaico.foundation.domains module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Domain implementations, used for checking values against specific ranges.  Typically used for enforcing parameter value obligations and return value guarantees, though Domains can be used for any broader filtering needs.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x19EBC4465B462A1E0A02F933EFA983F43A3C9592";
