...
/**
 * <p>
 * Module settings for the musaico.foundation.domains.iterators module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Iterators to step over the elements of arrays and Collections, as well as defense mechanisms (such as infinite loop protection).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0x178871C9940364121F46222A4719C87A7D6944E6";
    ...
    static final long VERSION = 20180406L;
