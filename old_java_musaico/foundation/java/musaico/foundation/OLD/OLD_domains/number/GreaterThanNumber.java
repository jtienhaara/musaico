...
/**
 * <p>
 * The domain of all numbers which are greater than a specific number.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    // The Number than which every number in this domain is greater.
    private final Number number;


    /**
     * <p>
     * Creates a new GreaterThanNumber domain.
     * </p>
     *
     * @param number The number than which every number in this domain
     *               is greater.  Must not be null.
     */
        ...
        throws NullPointerException
    {
        if ( number == null )
        {
            throw new NullPointerException ( "Cannot create an GreaterThanNumber null domain" );
        }
    ...
    /**
     * @return The value than which each input must be greater.
     *         Never null.
     */
    public Number value ()
    {
