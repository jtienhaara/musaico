...
/**
 * <p>
 * The domain of all numbers which are less than or equal to
 * a specific number.
 * </p>
 *
 *
 ...
 */
public class LessThanOrEqualToNumber
    ...
    implements Serializable
{
    ...
    // The Number which every number in this domain is less than or
    // equal to.
    ...
    /**
     * <p>
     * Creates a new LessThanOrEqualToNumber domain.
     * </p>
     *
     * @param number The number than every number in this domain
     *               is less than or equal to.  Must not be null.
     */
    public LessThanOrEqualToNumber (
                                    Number number
                                    )
        throws NullPointerException
    {
        if ( number == null )
        {
            throw new NullPointerException ( "Cannot create an LessThanOrEqualToNumber null domain" );
        }
                           ...
                           )
    {
        ...
        final LessThanOrEqualToNumber that =
            (LessThanOrEqualToNumber) obj;
        if ( this.number == null )
        {
            if ( that.number != null )
            {
    ...
    /**
     * @return The value which each input must be less than or equal to.
     *         Never null.
     */
    public Number value ()
    {
