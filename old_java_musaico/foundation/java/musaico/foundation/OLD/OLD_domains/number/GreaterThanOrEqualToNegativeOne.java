 ...
 */
public class GreaterThanOrEqualToNegativeOne
    ...
    implements Serializable
{
    ...
    /** The GreaterThanOrEqualToNegativeOne domain singleton. */
    public static final GreaterThanOrEqualToNegativeOne DOMAIN =
        new GreaterThanOrEqualToNegativeOne ();


    protected GreaterThanOrEqualToNegativeOne ()
    {
    }
