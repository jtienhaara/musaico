 ...
 */
public class LessThanOrEqualToOne
    ...
    implements Serializable
{
    ...
    /** The LessThanOrEqualToOne domain singleton. */
    public static final LessThanOrEqualToOne DOMAIN =
        new LessThanOrEqualToOne ();


    protected LessThanOrEqualToOne ()
    {
    }
