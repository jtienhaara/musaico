...
/**
 * <p>
 * The domain of all numbers which are greater than or equal to
 * a specific number.
 * </p>
 *
 *
    ...
    implements Serializable
{
    ...
    // The Number which every number in this domain is greater than or
    // equal to.
    ...
    /**
     * <p>
     * Creates a new GreaterThanOrEqualToNumber domain.
     * </p>
     *
     * @param number The number than every number in this domain
     *               is greater than or equal to.  Must not be null.
     */
        ...
        throws NullPointerException
    {
        if ( number == null )
        {
            throw new NullPointerException ( "Cannot create an GreaterThanOrEqualToNumber null domain" );
        }
                           ...
                           )
    {
        ...
        final GreaterThanOrEqualToNumber that =
            (GreaterThanOrEqualToNumber) obj;
        if ( this.number == null )
        {
            if ( that.number != null )
            {
    ...
    /**
     * @return The value which each input must be greater than or equal to.
     *         Never null.
     */
    public Number value ()
    {
