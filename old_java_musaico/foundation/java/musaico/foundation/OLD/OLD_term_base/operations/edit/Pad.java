...
/**
 * <p>
 * Returns each input Term with padding elements inserted
 * to bulk it up to a specific length.
 * </p>
 *
 * <p>
 * For example, if the term <code> { 1, 2, 3 } </code>
 ...
 *
 * <p>
 * If there are multiple padding elements then each element will be added
    ...
    implements ElementalOperation<VALUE, VALUE>, Serializable
{
     ...
     *                      the length of the term being built
