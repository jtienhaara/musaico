...
/**
 * <p>
 * Each Invocation of each Operation must not throw an Exception.
 * </p>
 *
 * <p>
 * For example, an Operation might be expected to return an Error
 * Term, even when it is invoked with a null input.
 * </p>
 *
 *
 * <p>
 ...
 */
public class OperationMustNotThrowException
    implements Contract<Invocation<?, ?>, OperationMustNotThrowException.Violation>, Serializable
{
    ...
    /** The OperationMustNotThrowException contract. */
    public static final OperationMustNotThrowException CONTRACT =
        new OperationMustNotThrowException ();


    // Enforces constructor and static method parameter obligations for us.
    private static final Advocate classContracts =
        new Advocate ( OperationMustNotThrowException.class );


    // Private constructor.  Use the singleton instead:
    // OperationMustNotThrowException.CONTRACT
    private OperationMustNotThrowException ()
    {
    }
    ...
    {
        return "Each invocation of each operation must execute cleanly,"
     ...
     */
    @Override
    public OperationMustNotThrowException.Violation violation (
            Object plaintiff,
            Invocation<?, ?> evidence
            )
    {
        return new OperationMustNotThrowException.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    {
        final OperationMustNotThrowException.Violation violation =
    ...
    /**
     * <p>
     * A violation of the OperationMustNotThrowException contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            OperationMustNotThrowException.serialVersionUID;


        /**
         * <p>
         * Creates a new OperationMustNotThrowException.Violation.
         * </p>
         *
