...
/**
 * <p>
 * Module settings for the musaico.foundation.operations.filter module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "The standard implementation for FilterElements and its related Operations, which can remove elements from a Term.";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xB739376BCD43BECA720B9A9B1E282D37074DD49A";
    ...
    static final long VERSION = 20161026L;
