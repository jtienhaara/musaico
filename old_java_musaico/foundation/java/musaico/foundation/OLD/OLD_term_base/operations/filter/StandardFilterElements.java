...
/**
 * <p>
 * Matches specific elements, or sequences of elements, against
 * specific filter(s), and removes all elements which do not match.
 * </p>
 *
 *
 * <p>
    ...
    implements FilterElements<VALUE>, Serializable
{
    ...
    /**
     * @see musaico.foundation.term.FilterElements#unique()
     */
    @Override
    public final StandardFilterElements<VALUE, VALUE> unique ()
        throws ReturnNeverNull.Violation
    {
        return this.pipe ( new Unique<VALUE> ( this.inputType () ),
                           Pipeline.ALL );
    }
}
