...
/**
 * <p>
 * A guarantee of any term except a Mutable value.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeMutable
    implements Contract<Term<?>, TermMustNotBeMutable.Violation>, Serializable
{
    ...
    /** The TermMustNotBeMutable contract. */
    public static final TermMustNotBeMutable CONTRACT =
        new TermMustNotBeMutable ();
    ...
    {
        return "The term must not be Mutable, so that no changes"
            + " to its internal state may be induced externally.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Mutable )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public TermMustNotBeMutable.Violation violation (
                                                      Object plaintiff,
                                                      Term<?> evidence
                                                      )
    {
        return new TermMustNotBeMutable.Violation ( this,
                                                     plaintiff,
                                                     evidence );
    }
    ...
    {
        final TermMustNotBeMutable.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeMutable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeMutable.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeMutable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Mutable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
