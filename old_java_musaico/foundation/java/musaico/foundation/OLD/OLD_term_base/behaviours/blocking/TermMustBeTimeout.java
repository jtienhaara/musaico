...
/**
 * <p>
 * A guarantee of a timeout term, which is a variant of No term caused
 ...
 */
public class TermMustBeTimeout
    implements Contract<Term<?>, TermMustBeTimeout.Violation>, Serializable
{
    ...
    /** The TermMustBeTimeout contract. */
    public static final TermMustBeTimeout CONTRACT =
        new TermMustBeTimeout ();
    ...
    {
        return "The term must be a Timeout, caused by waiting too"
                               ...
                               )
    {
        ...
        else if ( term instanceof Timeout )
        {
     ...
     */
    @Override
    public TermMustBeTimeout.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBeTimeout.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final TermMustBeTimeout.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeTimeout contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeTimeout.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeTimeout.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not a Timeout.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
