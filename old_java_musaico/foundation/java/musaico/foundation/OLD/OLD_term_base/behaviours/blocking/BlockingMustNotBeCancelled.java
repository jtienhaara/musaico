...
/**
 * <p>
 * A guarantee that each Blocking term has not been cancelled.
 * </p>
 *
 *
 * <p>
 ...
 */
public class BlockingMustNotBeCancelled
    implements Contract<Blocking<?>, BlockingMustNotBeCancelled.Violation>, Serializable
{
    ...
    public static final BlockingMustNotBeCancelled CONTRACT =
        new BlockingMustNotBeCancelled ();


    private BlockingMustNotBeCancelled ()
    {
    }
    ...
    {
        return "Each Blocking term must never have been cancelled.";
    }
    ...
    {
        if ( blocking_term == null )
        {
            return FilterState.DISCARDED;
        }

        final NonBlocking<?> maybe_final_term =
            blocking_term.await ( BigDecimal.ZERO );
        if ( maybe_final_term instanceof Cancelled )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public BlockingMustNotBeCancelled.Violation violation (
            Object plaintiff,
            Blocking<?> evidence
            )
    {
        return new BlockingMustNotBeCancelled.Violation (
            this,
            plaintiff,
            evidence );
    }
    ...
    /**
     * <p>
     * A violation of the BlockingMustNotBeCancelled contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            BlockingMustNotBeCancelled.serialVersionUID;


        /**
         * <p>
         * Creates a new BlockingMustNotBeCancelled.Violation.
         * </p>
         *
         ...
         *                  Must not be null.
         *
         * @param evidence The Blocking term which violated the contract.
         *                 Can be null.
         */
        public Violation (
                          Contract<?, ?> contract,
        ...
        {
            super ( contract,
                    "The specified Blocking term has been cancelled: "
                    + evidence
                    + ".", // description
                    plaintiff,
                    evidence,
