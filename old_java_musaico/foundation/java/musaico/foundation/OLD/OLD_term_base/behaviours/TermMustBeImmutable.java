...
/**
 * <p>
 * A guarantee of an Immutable term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeImmutable
    implements Contract<Term<?>, TermMustBeImmutable.Violation>, Serializable
{
    ...
    /** The TermMustBeImmutable contract. */
    public static final TermMustBeImmutable CONTRACT =
        new TermMustBeImmutable ();
    ...
    {
        return "The term must be Immutable, so that its elements"
            + " cannot be modified by external callers.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Immutable )
        {
     ...
     */
    @Override
        public TermMustBeImmutable.Violation violation (
                Object plaintiff,
                Term<?> evidence
                )
    {
        return new TermMustBeImmutable.Violation ( this,
                                                    plaintiff,
                                                    evidence );
    }
    ...
    {
        final TermMustBeImmutable.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeImmutable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeImmutable.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeImmutable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Immutable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
