...
import musaico.foundation.term.multiplicity.Unjust;


/**
 * <p>
 * A guarantee of a Term with an unjust value (anything less than One,
 * in essence, such as an Empty value or a Partial result and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeUnjust
    implements Contract<Term<?>, TermMustBeUnjust.Violation>, Serializable
{
    ...
    /** The TermMustBeUnjust contract. */
    public static final TermMustBeUnjust CONTRACT =
        new TermMustBeUnjust ();
    ...
    {
        return "The term must be Unjust, a term which contains"
            + " no elements, including errors and so on.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof Unjust )
        {
     ...
     */
    @Override
    public TermMustBeUnjust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustBeUnjust.Violation ( this,
                                                 plaintiff,
                                                 evidence );
    }
    ...
    {
        final TermMustBeUnjust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeUnjust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeUnjust.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeUnjust.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Unjust.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
