...
/**
 * <p>
 * A guarantee of a Term with just a single or multiple element value
 * (possibly infinite); never Empty or LessThanOne.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustBeJust
    implements Contract<Term<?>, TermMustBeJust.Violation>, Serializable
{
    ...
    /** The TermMustBeJust contract. */
    public static final TermMustBeJust CONTRACT =
        new TermMustBeJust ();
    ...
    {
        return "The term must be Just, 1 or more elements.";
    }
     ...
     */
    @Override
    public TermMustBeJust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustBeJust.Violation ( this,
                                              plaintiff,
                                              evidence );
    }
    ...
    {
        final TermMustBeJust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeJust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeJust.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeJust.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Just.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
