 ...
 */
public class TermMustBeMutable
    implements Contract<Term<?>, TermMustBeMutable.Violation>, Serializable
{
    ...
    /** The TermMustBeMutable contract. */
    public static final TermMustBeMutable CONTRACT =
        new TermMustBeMutable ();
    ...
    {
        return "The Term must be Mutable so that its internal state"
            + " can be changed.";
    }
     ...
     */
    @Override
    public TermMustBeMutable.Violation violation (
                                                   Object plaintiff,
                                                   Term<?> evidence
                                                   )
    {
        return new TermMustBeMutable.Violation ( this,
                                                  plaintiff,
                                                  evidence );
    }
    ...
    {
        final TermMustBeMutable.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustBeMutable contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustBeMutable.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustBeMutable.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was not Mutable.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
