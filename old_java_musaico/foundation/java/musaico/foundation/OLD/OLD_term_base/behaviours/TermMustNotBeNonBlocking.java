...
/**
 * <p>
 * A guarantee of any term except a non-blocking term.
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeNonBlocking
    implements Contract<Term<?>, TermMustNotBeNonBlocking.Violation>, Serializable
{
    ...
    /** The TermMustNotBeNonBlocking contract. */
    public static final TermMustNotBeNonBlocking CONTRACT =
        new TermMustNotBeNonBlocking ();
    ...
    {
        return "The term must not be NonBlocking.";
    }
                               ...
                               )
    {
        ...
        else if ( term instanceof NonBlocking )
        {
            return FilterState.DISCARDED;
        }
        else
     ...
     */
    @Override
    public TermMustNotBeNonBlocking.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotBeNonBlocking.Violation ( this,
                                                         plaintiff,
                                                         evidence );
    }
    ...
    {
        final TermMustNotBeNonBlocking.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeNonBlocking contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeNonBlocking.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeNonBlocking.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was NonBlocking.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
