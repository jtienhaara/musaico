...
/**
 * <p>
 * A guarantee of any term except an Unjust value
 * (allowing OneOrMore, Infinite, and so on Multiplicities,
 * disallowing Empty, Partial and so on).
 * </p>
 *
 *
 * <p>
 ...
 */
public class TermMustNotBeUnjust
    implements Contract<Term<?>, TermMustNotBeUnjust.Violation>, Serializable
{
    ...
    /** The TermMustNotBeUnjust contract. */
    public static final TermMustNotBeUnjust CONTRACT =
        new TermMustNotBeUnjust ();
    ...
    {
        return "The term must not be Unjust.";
    }
     ...
     */
    @Override
    public TermMustNotBeUnjust.Violation violation (
            Object plaintiff,
            Term<?> evidence
            )
    {
        return new TermMustNotBeUnjust.Violation ( this,
                                                    plaintiff,
                                                    evidence );
    }
    ...
    {
        final TermMustNotBeUnjust.Violation violation =
    ...
    /**
     * <p>
     * A violation of the TermMustNotBeUnjust contract.
     * </p>
     */
        ...
        implements Serializable
    {
        private static final long serialVersionUID =
            TermMustNotBeUnjust.serialVersionUID;


        /**
         * <p>
         * Creates a new TermMustNotBeUnjust.Violation.
         * </p>
         *
        ...
        {
            super ( contract,
                    "The term was Unjust.", // description
                    plaintiff,
                    evidence,
                    cause );
        }
