    ...
    implements Serializable
{
    ...
    private static final String DESCRIPTION =
        "Miscellaneous types of Reducibility, most of which are Reducible (must be reduced in order to arrive at a final value).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xD3C88E3D31162B21BEFF7ADB7A780DF9EF39344C";
    ...
    static final long VERSION = 20170126L;
