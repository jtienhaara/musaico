    ...
    extends Pipe<OUTPUT>, Serializable
{
    ...
    // musaico.foundation.operations.Pipe#clamp(long, musaico.foundation.operations.Pipe.Stream, musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#close(musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#inputPipes(musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#length(musaico.foundation.operations.Pipe.Stream, musaico.foundation.operations.Context)
    ...
    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#outputPipes(musaico.foundation.operations.Context)
    ...
    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#read(musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#read(java.lang.Object[], int, int, long, musaico.foundation.operatios.Pipe.Stream, musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#stream(musaico.foundation.operations.Context)

    // Every Pipe must implement
    // musaico.foundation.operations.Pipe#violation(musaico.foundation.operations.Context)
}
