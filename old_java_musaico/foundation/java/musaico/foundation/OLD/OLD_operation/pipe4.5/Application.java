    ...
    extends Pipe<OUTPUT>, Serializable
{
    ...
    // Every Pipe must implement
    // musaico.foundation.operation.Pipe#read(musaico.foundation.operation.Stream, long, musaico.foundation.operation.Context)

    // Every Pipe must implement
    // musaico.foundation.operation.Pipe#read(java.lang.Object[], int, int, long, long, musaico.foundation.operation.Context)
