...
public class TestGraph
{
                             ...
                             )
    {
        final Graph<String, Integer> one_node = // No arcs.
            new StandardGraph<String, Integer> (
                new StandardType<String> ( // node_value_class
                    String.class, // element_class
                    "" ),         // none
                new StandardType<Integer> ( // arc_value_class
        ...
        final Graph<String, Integer> cities1 =
            new StandardGraph<String, Integer> (
                ...
                "Halifax", // entry
                "Albufeira", // exit
                new StandardArc<String, Integer> (
                    "Halifax", 2000, "Albufeira" ) );
        ...
        final Graph<String, Integer> cities3 =
            new StandardGraph<String, Integer> (
                ...
                "Albufeira", // exit
                new StandardArc<String, Integer> (
                    "Halifax", 1000, "Toronto" ),
                new StandardArc<String, Integer> (
                    "Toronto", 2000, "Reykjavik" ),
                new StandardArc<String, Integer> (
                    "Reykjavik", 2000, "Toronto" ),
                new StandardArc<String, Integer> (
                    "Reykjavik", 1000, "Lisboa" ),
                new StandardArc<String, Integer> (
                    "Lisboa", 1000, "Reykjavik" ),
                new StandardArc<String, Integer> (
                    "Lisboa", 500, "Albufeira" ) );
        ...
        final Graph<Integer, Contract<?, ?>> operation1 =
            new StandardGraph<Integer, Contract<?, ?>> (
                new StandardType<Integer> (        // node_value_class
                    Integer.class, // element_class
                    0 ),           // none
                new StandardType<Contract<?, ?>> ( // arc_value_class
                    Contract.class, // element_class
                    Contract.NONE ),
                0, // entry
                2, // exit
                new StandardArc<Integer, Contract<?, ?>> (
                    0, Greeting.CONTRACT, 1 ),
                new StandardArc<Integer, Contract<?, ?>> (
                    1, Adjective.CONTRACT, 1 ),
                new StandardArc<Integer, Contract<?, ?>> (
                    1, Addressee.CONTRACT, 2 ) );
    ...
    public static class Greeting
        implements Contract<Term<String>, CheckedViolation>
    {
