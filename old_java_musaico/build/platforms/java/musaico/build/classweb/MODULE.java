...
/**
 * <p>
 * Module settings for the musaico.build.tools module.
 * </p>
 *
 *
 * <p>
    ...
    implements Serializable
{
    ...
    private static final String COPYRIGHT =
        "Copyright (c) 2012-2015 Johann Tienhaara <jtienhaara@yahoo.com>";

    /** Human-readable description of the purpose of this module. */
    private static final String DESCRIPTION =
        "Tools for outputting documentation about classes (Musaico or otherwise).";

    /** Run "make serializable" to test and/or generate a new hash. */
    private static final String HASH =
        "0xA641F6D89CBA61ECDA0473B033001B9332480415";

    /** The license under which binaries and/or source code of this
     *  module may be distributed.
     *  @see musaico.module.License */
    private static final License LICENSE = License.BSD;
    ...
    static final long VERSION = 20180901L;
